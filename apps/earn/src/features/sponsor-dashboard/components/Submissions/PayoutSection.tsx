...
function openPaymentRecord(record: string) {
  if (/^https?:\/\//i.test(record)) {
            ...
            payment.txId && (
              <div key={index} className="my-2">
                <div
                  ...
                  onClick={() => {
                    openPaymentRecord(payment.txId);
                  }}
                >
                  <p className="text-sm font-medium text-slate-500">
  ...
  if (bounty.isFndnPaying) {
    return (
      <div className="rounded-lg border border-slate-200 bg-white py-8 text-center text-slate-500">
        Payments for this listing are handled by the foundation.
      </div>
    );
  }
        ...
        <div className="flex items-center justify-between rounded-lg border border-slate-200 bg-slate-50 px-4 py-3">
          <div className="flex flex-col gap-1">
            ...
            <p className="text-xs text-slate-500">
              Track recorded payments to winners.
            </p>
          </div>
        </div>
