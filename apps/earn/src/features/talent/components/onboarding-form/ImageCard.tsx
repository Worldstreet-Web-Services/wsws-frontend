...
import {
  ...
  AvatarGroupList,
  AvatarImage,
} from '@earn/components/ui/avatar';
import { Card, CardContent } from '@earn/components/ui/card';
...
import { roundToNearestThousand } from '@earn/utils/number';
...
import { liveOpportunitiesQuery } from '@earn/features/listings/queries/live-opportunities';
      ...
      <div className="absolute top-2/4 left-2/4 w-[25rem] -translate-x-2/4 -translate-y-2/4">
        <Card className="rounded-xl">
          <CardContent className="grid grid-cols-3 items-center gap-x-4 gap-y-4 py-8">
            ...
            <div className="col-span-2">
              <p className="text-sm text-slate-500">
                has been earned by freelancers like you on TSION Earn
              </p>
            </div>
