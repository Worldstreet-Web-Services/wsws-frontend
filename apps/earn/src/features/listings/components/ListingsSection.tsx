...
import { useScrollShadow } from '@earn/hooks/use-scroll-shadow';
...
import { getRegionSlug } from '@earn/features/listings/utils/region';
import { CATEGORY_NAV_ITEMS } from '@earn/features/navbar/constants';
