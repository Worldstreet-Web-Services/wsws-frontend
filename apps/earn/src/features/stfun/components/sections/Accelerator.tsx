...
const partners2 = [
  {
    ...
    name: 'Colosseum',
    description:
      "An organization running TSION's hackathons, accelerating select winners, and investing in their breakout startups.",
  ...
  },
  {
    ...
    perks:
      'Best teams get recommended to the SpringX Accelerator Program at the TSION APAC Summit in Malaysia in June 2024.',
