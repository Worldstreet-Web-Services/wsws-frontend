...
import MdOutlineAccountBalanceWallet from '@earn/components/icons/MdOutlineAccountBalanceWallet';
...
import { truncateString } from '@earn/utils/truncateString';

import { type Grant, type GrantQuestion } from '@earn/features/grants/types';
import {
              ...
              <div className="flex w-full items-center gap-2">
                ...
                <div>
                  ...
                  <Link
                    ...
                    className="text-brand-grey flex w-full items-center gap-1 text-xs font-medium whitespace-nowrap"
