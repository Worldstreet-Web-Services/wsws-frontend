...
import RxUpload from '@earn/components/icons/RxUpload';
import { Dialog, DialogContent, DialogTitle } from '@earn/components/ui/dialog';
import { Input } from '@earn/components/ui/input';
import { Progress } from '@earn/components/ui/progress';
import { useImageUpload } from '@earn/hooks/use-image-upload';
import {
  type ImageSource,
  MAX_FILE_SIZE,
  MAX_FILE_SIZE_LARGE,
} from '@earn/lib/image-upload/client';
        ...
        >
          ...
          <div className="flex items-center justify-between border-b border-slate-200 bg-slate-50 px-4 py-3">
            <button
              ...
              className="focus-visible:ring-brand-grey/40 rounded-md p-1.5 text-slate-500 transition-colors hover:bg-white hover:text-slate-700 focus:outline-none focus-visible:ring-2"
            ...
            <button
              ...
              className="bg-brand-grey hover:bg-brand-grey-dark focus-visible:ring-brand-grey/40 flex items-center gap-2 rounded-md p-2 text-center text-sm text-white focus-visible:ring-2"
          ...
          <div className="relative flex flex-1 items-center justify-center overflow-hidden bg-slate-100">
            {value.length > 1 && (
              <button
                ...
                className="focus-visible:ring-brand-grey/40 absolute left-4 z-10 rounded-full bg-white/90 p-2 text-slate-500 shadow-md backdrop-blur-sm transition-all hover:bg-white focus:outline-none focus-visible:ring-2"
            ...
            {value.length > 1 && (
              <button
                type="button"
                onClick={goToNext}
                className="focus-visible:ring-brand-grey/40 absolute right-4 z-10 rounded-full bg-white/90 p-2 text-slate-500 shadow-md backdrop-blur-sm transition-all hover:bg-white focus:outline-none focus-visible:ring-2"
                ...
                return (
                  <button
                    ...
                    className={cn(
                      ...
                      index === previewIndex
                        ? 'border-brand-grey ring-brand-grey/40 ring-2'
