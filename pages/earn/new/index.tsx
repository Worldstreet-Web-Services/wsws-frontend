...
import MdCheck from '@earn/components/icons/MdCheck';
import { SponsorButton } from '@earn/components/ProfileSetup/SponsorButton';
import { TalentButton } from '@earn/components/ProfileSetup/TalentButton';
import { Avatar, AvatarFallback, AvatarImage } from '@earn/components/ui/avatar';
                ...
                >
                  ...
                  <div className="flex flex-col gap-5 px-4">
                    <BulletPoint type="TALENT">
                      Contribute to top TSION projects
                    </BulletPoint>
                    <BulletPoint type="TALENT">
          ...
          <div className="flex w-full flex-col gap-9">
            ...
            <div className="-mt-3 flex items-center justify-between gap-3 px-3">
              <ExternalImage
                ...
                alt="Token Registry Icon"
                src={'/landingsponsor/sponsors/token-registry.webp'}
              />

              <ExternalImage
                className="h-8 object-contain"
                alt="TSION Wallet Icon"
