...
import { statsDataQuery, trackDataQuery } from '@earn/queries/hackathon';
import { RedactedLogo } from '@earn/svg/redacted';
    ...
    <Default
      ...
      meta={
        <>
          ...
          />
          <Meta
            title="TSION [REDACTED] Hackathon | TSION Earn"
            description="Join the TSION Hackathon—a data-driven challenge empowering analysts, data scientists, and on-chain sleuths to expose fraud, build insightful dashboards, and advance TSION’s social layer."
        ...
        >
          ...
          >
            ...
            <p className="mt-4 md:text-xl">
              Strengthen TSION’s social layer by{' '}
...
export const getServerSideProps: GetServerSideProps = async ({}) => {
  const hackathon = await fetchHackathonPublicStats('redacted');
...
const faqs: { question: string; answer: string }[] = [
  {
    ...
    answer: `The [REDACTED] Hackathon by <a target='_blank' href='https://www.worldstreet.dev/'>TSION</a> is a virtual TSION event centered on on-chain forensics, security, data transparency, and real-time monitoring.`,
  },
  {
