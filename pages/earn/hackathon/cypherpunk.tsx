...
import { CypherpunkLogo } from '@earn/svg/cypherpunk-logo';
    ...
    <Default
      ...
      meta={
        <>
          ...
          />
          <Meta
            title="Cypherpunk | TSION Earn"
            description={`TSION Cypherpunk Online Hackathon`}
    ...
    >
      ...
      <div className="mt-4 mb-1 flex w-full max-w-[18.5rem] flex-col items-center gap-4 text-black sm:w-auto sm:max-w-none">
        <p className="max-w-76 text-sm sm:text-base">
          Submit to side tracks of the latest TSION Global Hackathon
        </p>
...
const faqs: { question: string; answer: string }[] = [
  {
    ...
    answer:
      'Sidetracks are extra challenges hosted by TSION Earn, separate from Colosseum’s Cypherpunk tracks. They offer additional opportunities to build unique projects and win special prizes.',
  },
  {
  ...
  },
  {
    ...
    answer:
      'Check out <a href="https://www.colosseum.com/cypherpunk/resources" target="_blank">Colosseum’s Developer Resources page</a>. You’ll find documentation, tools, tutorials, and everything you need to build on TSION.',
  },
  {
...
export const getServerSideProps: GetServerSideProps = async ({}) => {
  const hackathon = await fetchHackathonPublicStats('cypherpunk');
  if (!hackathon.startDate || !hackathon.deadline) {
