...
import { SubmissionLabels } from '@earn/prisma/enums';
            ...
            <div className="flex w-full items-center justify-between px-4 pt-3">
              <div className="flex w-full items-center gap-2">
                ...
                <div>
                  ...
                  <Link
                    className="text-brand-grey flex w-full items-center text-xs font-medium whitespace-nowrap"
                ...
                {selectedSubmission?.isWinner &&
                  ...
                  paymentTxId && (
                    <Button
                      ...
                      onClick={() => {
                        if (/^https?:\/\//i.test(paymentTxId)) {
                          window.open(paymentTxId, '_blank');
                        }
                      }}
                      size="default"
                      variant="outline"
