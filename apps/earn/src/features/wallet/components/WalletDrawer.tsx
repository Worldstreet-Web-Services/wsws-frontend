    ...
    if (privyUser?.mfaMethods.length === 0) {
      toast(
        <div className="relative flex flex-col gap-1">
          ...
          <div
            className={cn(
              'text-brand-grey mt-1 pr-6 text-xl font-bold',
          ...
          <Button
            ...
            className={cn(
              'bg-brand-grey hover:bg-brand-grey-dark mt-2 w-full rounded-lg px-4 py-2.5 text-sm font-semibold text-white transition-colors',
              ...
              {view === 'main' && (
                <div className="w-full items-end justify-between">
                  <Button
                    ...
                    className={cn(
                      'bg-brand-grey mt-3 rounded-lg px-5 text-base',
                      user?.isPro && 'bg-zinc-700 hover:bg-zinc-800',
                    )}
