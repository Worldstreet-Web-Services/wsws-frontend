...
const faqs = [
  {
    ...
    answer: `Any team or project that is building in the TSION ecosystem can sponsor a listing on TSION Earn. Size of the team or operations don't matter — you can be a tokenised project or a small grantee; as long as you are building on the TSION blockchain, you can add a listing on Earn.`,
  },
  {
  ...
  },
  {
    ...
    answer: `The sponsors are supposed to review, announce, and pay out the winners on TSION Earn. It's super simple to manage your submissions, all within Earn.`,
  },
  {
  ...
  },
  {
    ...
    answer: `TSION Earn is a platform to get work done from crypto-native talent. This can be in the form of bounties (get the same work done by many people) or hiring freelancers in the form of Project listings.
<br />
