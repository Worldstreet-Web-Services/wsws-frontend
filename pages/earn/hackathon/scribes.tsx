...
import { ScribesLogo } from '@earn/svg/scribes-logo';
...
export default function Scribes() {
  ...
  return (
    <Default
      ...
      meta={
        <Meta
          title="TSION Scribes | TSION Earn"
      ...
      <div>
        ...
        >
          ...
          <p className="mt-4 px-6 text-center text-slate-600">
            Participate in TSION&apos;s first ever content hackathon
          </p>
          <div className="flex pb-4">
            <Button
              className="my-6 rounded-full bg-black py-4 text-sm hover:bg-[#a459ff]"
              onClick={() =>
                window.open('https://discord.gg/worldstreet', '_blank')
              }
            >
              Join TSION Collective&apos;s Discord
            </Button>
          </div>
        </div>
