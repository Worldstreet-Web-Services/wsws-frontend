...
async function $7adb23b0109cc36a$var$_init(props) {
  ...
  while (categoryIndex--) {
    ...
    const { categoryIcons: categoryIcons2 } = props;
    if (categoryIcons2) {
      const icon = categoryIcons2[category.id];
...
var $ec8c39fdad15601a$export$2e2bcd8739ae039 = class extends (0, $dc040a17866866fa$export$221d75b3f55bb0bd) {
  renderIcon(category) {
    ...
    const categoryIcons2 = (0, $fcccfb36ed0cde68$export$2e2bcd8739ae039).categories[category.id] || (0, $fcccfb36ed0cde68$export$2e2bcd8739ae039).categories.custom;
    const style = this.props.icons == "auto" ? $ec8c39fdad15601a$var$THEME_ICONS[this.props.theme] : this.props.icons;
    return categoryIcons2[style] || categoryIcons2;
  }
  render() {
...
var $89bd6bb200cc8fef$export$2e2bcd8739ae039 = class extends (0, $fb96b826c0c5f37a$export$16fa2f45be04daa8) {
  ...
  initGrid() {
    const { categories: categories2 } = (0, $7adb23b0109cc36a$export$2d0294657ab35f1b);
...
// ../bits/src/bits.flairPicker.ts
async function initModule(cfg) {
  var _a;
  if (cfg.element.classList.contains("emoji-done")) return;
  const theme = document.body.dataset.theme === "system" ? "auto" : document.body.dataset.theme === "light" ? "light" : "dark";
  const opts = {
    ...cfg,
    ...
    theme,
    exceptEmojis: (_a = cfg.element.dataset.exceptEmojis) == null ? void 0 : _a.split(" ")
  };
  const picker = new $efa000751917694d$export$2e2bcd8739ae039(opts);
  cfg.element.prepend(picker);
  cfg.element.classList.add("emoji-done");
  $(cfg.element).find("em-emoji-picker").attr("trap-bypass", "1");
}
var makeEmojiData = async () => {
...
//# sourceMappingURL=bits.flairPicker.NZPZJ3FV.js.map
