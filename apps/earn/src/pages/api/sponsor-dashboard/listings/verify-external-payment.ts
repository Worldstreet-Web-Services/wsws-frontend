...
import { checkListingSponsorAuth } from '@earn/features/auth/utils/checkListingSponsorAuth';
...
} from '@earn/features/sponsor-dashboard/types';
import {
  validatePayment,
  type ValidationResult,
} from '@earn/features/sponsor-dashboard/utils/paymentRPCValidation';
    ...
    for (const paymentLink of paymentLinks) {
      try {
        ...
        const actualPaidAmount = isProject
          ? remainingAmount
          : rpcValidationResult.actualAmount || winnerReward;
