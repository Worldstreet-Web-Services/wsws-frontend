...
import { Sheet, SheetClose, SheetContent } from '@earn/components/ui/sheet';
        ...
        <div className="px-6">
          ...
          {user && !user.currentSponsorId && (
            <Link
              ...
              onClick={() => posthog.capture('get started_sponsor navbar')}
            >
              <Button variant="ghost" className="text-brand-grey text-base">
                Get Started
              </Button>
            </Link>
          )}
          ...
          {user && !!user.currentSponsorId && (
            ...
            >
              <Button variant="outline" className="text-brand-grey text-base">
                Post for Free
              </Button>
            </Link>
          )}
    ...
    <div className="flex items-center justify-between border-b border-black/20 bg-white px-1 py-2 lg:hidden">
      ...
      {ready && !authenticated && (
        <Link
          ...
          onClick={() => posthog.capture('login_navbar')}
        >
          <Button variant="ghost" className="text-brand-grey mr-2 text-base">
            Login
          </Button>
        </Link>
      )}
