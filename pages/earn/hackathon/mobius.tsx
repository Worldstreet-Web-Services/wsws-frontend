    ...
    <Default
      ...
      meta={
        <>
          ...
          />
          <Meta
            title="Sonic Mobius | TSION Earn"
            description={`Join the first-ever SVM hackathon on TSION – Sonic Mobius Hackathon – with a $1,000,000 prize pool! Build, launch on Sonic SVM Mainnet, and onboard the next billion users.`}
...
function Hero({
  ...
  return (
    ...
    >
      ...
      >
        The first SVM hackathon on TSION
      </p>
      ...
      <div className="flex w-full items-center gap-5">
        ...
        <div className="flex h-full max-w-xl flex-col justify-between gap-0.5">
          ...
          <span className="pr-0 text-xs leading-[0.85rem] font-medium text-slate-500 md:text-sm md:leading-[1.0625rem]">
            ...
            chosen by Mobius’ panel of top judges from the TSION ecosystem as
...
const faqs: { question: string; answer: string }[] = [
  {
    ...
    answer:
      'Sonic Mobius Hackathon is hosted by SonicSVM and is the first SVM hackathon on TSION to empower builders to launch games and applications on Sonic.',
  },
  {
...
export const getServerSideProps: GetServerSideProps = async ({}) => {
  const hackathon = await fetchHackathonPublicStats('mobius');
  if (!hackathon.startDate || !hackathon.deadline) {
