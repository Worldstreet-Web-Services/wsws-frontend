...
import { RegionCombobox } from '@earn/components/shared/RegionCombobox';
import { SkillsSelect } from '@earn/components/shared/SkillsSelectNew';
...
import { MultiSelect, type Option } from '@earn/components/ui/multi-select';
import {
  Select,
  SelectContent,
  SelectItem,
  SelectTrigger,
  SelectValue,
} from '@earn/components/ui/select';
...
import type { PoW } from '@earn/interface/pow';
import { Default } from '@earn/layouts/Default';
import { Meta } from '@earn/layouts/Meta';
import { api } from '@earn/lib/api';
import { fetchActiveChapters } from '@earn/lib/earn-public-data';
import { useUser } from '@earn/store/user';
import { cn } from '@earn/utils/cn';

import { SocialInputAll } from '@earn/features/social/components/SocialInput';
import { extractSocialUsername } from '@earn/features/social/utils/extractUsername';
import { AddProject } from '@earn/features/talent/components/AddProject';
import { UpdateLocationConfirmModal } from '@earn/features/talent/components/UpdateLocationConfirmModal';
import {
  CommunityList,
  IndustryList,
  web3Exp,
  workExp,
  workType,
} from '@earn/features/talent/constants';
import { type ProfileFormData, profileSchema } from '@earn/features/talent/schema';
import { hasDevSkills } from '@earn/features/talent/utils/skills';
                    ...
                    <div className="flex items-center gap-2">
                      <FormControl>
                        <Checkbox
                          ...
                          className="text-brand-grey data-[state=checked]:border-brand-grey data-[state=checked]:bg-brand-grey mr-1"
                        ></Checkbox>
                      </FormControl>
