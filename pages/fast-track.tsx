...
import FastTrackContainer from '@earn/features/stfun/components/common/FastTrackContainer';
import Accelerator from '@earn/features/stfun/components/sections/Accelerator';
import FastTrackFaq from '@earn/features/stfun/components/sections/FastTrackFaq';
...
export default function FastTrack() {
  return (
    <>
      <Meta
        title="Fast Track | Accelerate Your TSION Idea"
