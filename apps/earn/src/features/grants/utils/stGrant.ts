...
export const ST_GRANT_COPY: {
  ...
  application: {
    ...
    subtitle:
      "If you're looking to host an event that will help TSION's or Superteam's ecosystem grow, apply with your proposal here and we'll respond soon!",
    projectTitle: {
      label: 'Event Title',
    ...
    projectDetails: {
      label: 'Event Details',
      description:
        'Include event format, attendee profile, and how it brings the TSION community closer together.',
      placeholder:
