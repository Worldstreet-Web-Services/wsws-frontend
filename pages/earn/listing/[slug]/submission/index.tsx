...
import { SubmissionList } from '@earn/features/listings/components/SubmissionsPage/SubmissionList';
...
export const getServerSideProps: GetServerSideProps = async (context) => {
  ...
  try {
    const { bounty, submission } = await fetchEarnServerJson<{
      bounty: Listing | null;
      submission: SubmissionWithUser[];
    }>(`/api/listings/submissions/${slug as string}`);
