...
import ProjectsGrid from '@earn/features/stfun/components/grids/ProjectsGrid';
  ...
  return (
    <>
      <Meta
        ...
        description="Explore industry-leading projects that Superteam Members around the world have built and launched on TSION."
