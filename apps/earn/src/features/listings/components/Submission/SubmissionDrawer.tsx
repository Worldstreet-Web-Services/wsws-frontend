...
import { VerifiedXIcon } from '@earn/components/icons/VerifiedXIcon';
import { RichEditor } from '@earn/components/shared/RichEditor';
...
import { ScrollArea } from '@earn/components/ui/scroll-area';
import { SideDrawer, SideDrawerContent } from '@earn/components/ui/side-drawer';
import { useDisclosure } from '@earn/hooks/use-disclosure';
import { useServerTimeSync } from '@earn/hooks/use-server-time';
...
import { chaptersQuery } from '@earn/features/chapters/queries/chapters';
                ...
                {isHackathon && !editMode && (
                  <div className="mb-4 flex items-start space-x-3">
                    <Checkbox
                      id="terms"
                      className={cn(
                        'data-[state=checked]:border-brand-grey data-[state=checked]:bg-brand-grey mt-1',
                        isPro &&
                    ...
                    className={cn(
                      ...
                      editMode &&
                        (isPro
                          ...
                          : 'border-brand-grey hover:text-brand-grey-dark text-white'),
