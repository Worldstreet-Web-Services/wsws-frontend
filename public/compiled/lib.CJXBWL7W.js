...
function annotationShapes(node) {
  ...
  if (uci && san && glyphs) {
    return glyphs.slice(0, maxGlyphs).map((glyph, idx) => {
      ...
      const destSquare = san.startsWith("O-O") ? squareRank(move.to) === 0 ? san.startsWith("O-O-O") ? "c1" : "g1" : san.startsWith("O-O-O") ? "c8" : "g8" : makeSquare(move.to);
...
//# sourceMappingURL=lib.CJXBWL7W.js.map
