  ...
  return (
    ...
    >
      ...
      <Reveal className="relative z-10 max-w-[760px] px-6 text-center">
        <h2 className="ws-serif mx-auto max-w-[15ch] text-[clamp(40px,6.5vw,88px)] leading-none tracking-[-0.03em]">
          Your money. Your keys. Your calling.
        </h2>
        ...
        <p className="mt-3.5 text-[13px] font-light text-white/60">
