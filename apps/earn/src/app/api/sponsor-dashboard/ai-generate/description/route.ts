...
import { aiGenerateRateLimiter } from '@earn/lib/ratelimit';
import { checkAndApplyRateLimitApp } from '@earn/lib/rateLimiterService';
...
import { autoGenerateChatSchema } from '@earn/features/listing-builder/components/AutoGenerate/schema';
  ...
  try {
    ...
    const result = streamText({
      ...
      headers: {
        ...
        'X-Title': 'TSION Earn - AI Listing Builder',
      },
    });
