...
import { type TRewardsGenerateResponse } from '@earn/app/api/sponsor-dashboard/ai-generate/rewards/route';
import { type TTitleGenerateResponse } from '@earn/app/api/sponsor-dashboard/ai-generate/title/route';
import { type TTokenGenerateResponse } from '@earn/app/api/sponsor-dashboard/ai-generate/token/route';
import { type BountyType } from '@earn/generated/prisma/enums';
import { type Skills } from '@earn/interface/skills';
import { api } from '@earn/lib/api';
import { type HackathonModel } from '@earn/prisma/models/Hackathon';
import { convertUndefinedToNull } from '@earn/utils/undefinedToNull';
