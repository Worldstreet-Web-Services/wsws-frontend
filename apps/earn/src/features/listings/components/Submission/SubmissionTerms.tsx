...
import { TERMS_OF_USE } from '@earn/constants/TERMS_OF_USE';
      ...
      >
        ...
        >
          <ul className="list-disc space-y-2 pl-5">
            ...
            <li>
              TSION Earn acts solely as a platform for the Partner to list
              contests, bounties, projects or similar engagements{' '}
              {`("Activities")`} on its platform {`("ST Earn Platform")`}.
            </li>
            <li>
              TSION Earn shall not be liable for any Activities listed by
            ...
            <li>
              ...
              their own risk and discretion. TSION Earn disclaims all
            ...
            <li>
              ...
              parties involved. TSION Earn shall not be responsible for
              mediating or resolving such disputes.
            </li>
            <li>
              By using the platform and participating in any Activities, users
              agree to release TSION Earn from any claims, liabilities, or
              damages arising from their participation in Activities listed by
              Partners.
            </li>
            <li>
              TSION Earn does not guarantee the accuracy or legality of
            ...
            <li>
              ...
              hold TSION Earn harmless from any claims, damages, or
