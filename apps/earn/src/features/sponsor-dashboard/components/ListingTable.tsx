...
import IoDuplicateOutline from '@earn/components/icons/IoDuplicateOutline';
import ProIcon from '@earn/components/icons/ProIcon';
import { SortableTH } from '@earn/components/shared/sortable-th';
...
import { BoostButton } from '@earn/features/listing-builder/components/Form/Boost/BoostButton';
import { isListingEditable } from '@earn/features/listing-builder/utils/isListingEditable';
...
import { getListingIcon } from '@earn/features/listings/utils/getListingIcon';
import {
  getListingStatus,
  getListingTypeLabel,
} from '@earn/features/listings/utils/status';
                  ...
                  <TableCell className="px-0 py-2">
                    {listing.status === 'OPEN' && !!listing.isPublished ? (
                      <Button
                        variant="ghost"
                        size="sm"
                        className="ph-no-capture text-brand-grey hover:bg-brand-grey text-[13px] font-medium hover:text-white"
                        onClick={() => {
                          posthog.capture('submissions_sponsor');
