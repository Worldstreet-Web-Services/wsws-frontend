...
import FaCopy from '@earn/components/icons/FaCopy';
import FaTelegram from '@earn/components/icons/FaTelegram';
import FaWhatsapp from '@earn/components/icons/FaWhatsapp';
...
export const ShareProfile = ({ isOpen, onClose, username, id }: Props) => {
  ...
  const shareMessage =
    id === user?.id
      ? 'Check out my profile on TSION Earn!'
      : 'Check out this profile on TSION Earn!';
