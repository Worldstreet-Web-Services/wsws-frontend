...
// ../../node_modules/.pnpm/swiper@12.2.0/node_modules/swiper/shared/ssr-window.esm.mjs
...
// ../../node_modules/.pnpm/swiper@12.2.0/node_modules/swiper/shared/utils.mjs
...
// ../../node_modules/.pnpm/swiper@12.2.0/node_modules/swiper/shared/swiper-core.mjs
var support;
...
// ../../node_modules/.pnpm/swiper@12.2.0/node_modules/swiper/modules/keyboard.mjs
function Keyboard({
  swiper,
  extendParams,
  on,
...
// ../../node_modules/.pnpm/swiper@12.2.0/node_modules/swiper/modules/mousewheel.mjs
function Mousewheel({
  swiper,
  extendParams,
  on,
...
// ../../node_modules/.pnpm/swiper@12.2.0/node_modules/swiper/shared/create-element-if-not-defined.mjs
...
// ../../node_modules/.pnpm/swiper@12.2.0/node_modules/swiper/modules/navigation.mjs
...
// ../../node_modules/.pnpm/swiper@12.2.0/node_modules/swiper/shared/classes-to-selector.mjs
function classesToSelector(classes2 = "") {
  return `.${classes2.trim().replace(/([\.:!+\/()[\]#>~*^$|=,'"@{}\\])/g, "\\$1").replace(/ /g, ".")}`;
}

// ../../node_modules/.pnpm/swiper@12.2.0/node_modules/swiper/modules/pagination.mjs
function Pagination({
  swiper,
  extendParams,
  on,
...
// ../../node_modules/.pnpm/swiper@12.2.0/node_modules/swiper/modules/autoplay.mjs
function Autoplay({
  swiper,
  extendParams,
  on,
...
// ../recap/src/ui.ts
var animateNumber = (counter, opts) => {
  const o = { duration: 1500, render: numberFormat, ...opts };
  const value = parseInt(counter.dataset["value"] || "0");
  const startAt = performance.now();
  const stopAt = startAt + o.duration;
  const animate = () => {
    const now2 = performance.now();
    if (now2 >= stopAt) counter.innerHTML = o.render(value);
    else {
...
var loadOpeningLpv = (el, color, opening) => {
  const lpv = start(el, {
    pgn: opening.pgn,
    initialPly: 0,
...
// ../recap/src/util.ts
function formatDuration(seconds, glue = "<br>") {
...
var perfIsSpeed = (p) => ["ultraBullet", "bullet", "blitz", "rapid", "classical", "correspondence"].includes(p);
var perfLabel = (p) => perfIsSpeed(p.key) ? i18n.recap.shareableFavouriteTimeControl : i18n.recap.shareableFavouriteVariant;

// ../recap/src/swiper.ts
var makeSwiper = (opts) => (element) => {
  const progressDiv = element.querySelector(".autoplay-progress");
  const progressCircle = element.querySelector(".autoplay-progress svg");
  const progressContent = element.querySelector(".autoplay-progress span");
  const urlSlide = window.location.hash ? parseInt(window.location.hash.slice(1)) : void 0;
  ...
  const options = {
    ...
    on: {
      autoplayTimeLeft(swiper2, time, progress) {
        if (swiper2.isEnd) progressDiv.style.display = "none";
      ...
      slideChange(swiper2) {
        setTimeout(() => {
          var _a, _b, _c;
          const slide2 = element.querySelector(".swiper-slide-active");
          if (slide2) {
            if (swiper2.isEnd) (_a = swiper2.autoplay) == null ? void 0 : _a.stop();
            onSlideChange(slide2);
            if ((_b = swiper2.autoplay) == null ? void 0 : _b.paused) (_c = swiper2.autoplay) == null ? void 0 : _c.resume();
          }
        }, 200);
      }
    }
  };
  const swiper = window.s = new Swiper(element, options);
  $(element).on("click", () => {
...
var lpvTimer;
function onSlideChange(slide2) {
  slide2.querySelectorAll(".animated-number").forEach((counter) => {
    animateNumber(counter, {});
  });
  slide2.querySelectorAll(".animated-time").forEach((counter) => {
    animateNumber(counter, { duration: 1e3, render: formatDuration });
  });
  slide2.querySelectorAll(".animated-pulse").forEach((counter) => {
    counter.classList.remove("animated-pulse");
    setTimeout(() => {
      counter.classList.add("animated-pulse");
    }, 100);
  });
  slide2.querySelectorAll(".lpv").forEach((el) => {
...
// ../recap/src/constants.ts
var totalGames = 1825e6;
var pieceGrams = 41;

// ../recap/src/slides.ts
var confettiCanvas = () => hl("canvas#confetti", {
  hook: onInsert(() => {
...
var hi = (user) => hl("h2", i18n.recap.hiUser.asArray(fullName(user)));
var loading = (user) => slideTag("await")([hi(user), hl("p", i18n.recap.awaitQuestion), spinnerVdom()]);
var init2 = (user) => slideTag("init")([
  confettiCanvas(),
  hi(user),
  hl("img.recap__logo", { attrs: { src: site.asset.url("logo/lichess-white.svg") } }),
  hl("h2", i18n.recap.initTitle)
]);
var noGames = () => slideTag("no-games")([
...
var nbGames = (r) => {
  return slideTag("games")([
    hl(
      "div.recap--massive",
      i18n.site.nbGames.asArray(r.games.nbs.total, hl("strong", animateNumber2(r.games.nbs.total)))
    ),
    hl("div", [
      r.games.nbs.win && hl("p", i18n.recap.gamesYouWon.asArray(hl("strong", animateNumber2(r.games.nbs.win)))),
      hl("p", i18n.recap.gamesNextQuestion)
    ])
  ]);
};
var timeSpentPlaying = (r) => {
...
var nbMoves = (r) => {
  return slideTag(
    ...
    hl(
      "div.recap--massive",
      i18n.recap.nbMoves.asArray(r.games.moves, hl("strong", animateNumber2(r.games.moves)))
    ),
    hl("div", [
...
var opponents = (r) => {
  return slideTag("opponents")([
    ...
    hl(
      ...
      hl(
        "tbody",
        r.games.opponents.map(
          (o) => hl("tr", [
            hl("td", opponentLink(o.value)),
            hl("td", i18n.site.nbGames.asArray(o.count, animateNumber2(o.count)))
          ])
        )
      )
    )
...
var opponentLink = (o) => hl("a", { attrs: { href: `/@/${o.name}` } }, [userFlair(o) || noFlair(o), userTitle(o), o.name]);
var userFallbackFlair = /* @__PURE__ */ new Map();
var noFlair = (o) => {
  const randomFlair = userFallbackFlair.get(o.id) || userFallbackFlair.set(
    o.id,
    (() => shuffle([
    ...
    hl("div", [
      hl(
        ...
        i18n.recap.firstMoveStats.asArray(
          hl("div", [hl("strong", animateNumber2(firstMove.count)), ` (${percentFormat(ofTotal, 2)})`])
        )
      )
    ])
  ]);
};
var openingColor = (os, color) => {
  const o = os[color];
  if (!o.count) return void 0;
    ...
    hl("div", [
      hl(
        ...
        i18n.recap[color === "white" ? "openingsMostPlayedAsWhite" : "openingsMostPlayedAsBlack"].asArray(
          o.count,
          hl("strong", animateNumber2(o.count))
        )
      )
    ])
  ]);
    ...
    r.puzzles.nbs.total ? [
      hl(
        ...
        i18n.site.nbPuzzles.asArray(
          r.puzzles.nbs.total,
          hl("strong", animateNumber2(r.puzzles.nbs.total))
        )
      ),
      hl("div", [
        !!r.puzzles.nbs.win && hl(
          "p",
          i18n.recap.puzzlesYouWonOnFirstTry.asArray(hl("strong", animateNumber2(r.puzzles.nbs.win)))
        ),
        !!r.puzzles.votes.nb && hl(
          "p",
          i18n.recap.puzzlesThanksVoting.asArray(
            r.puzzles.votes.nb,
            hl("strong", animateNumber2(r.puzzles.votes.nb))
          )
        ),
        !!r.puzzles.votes.themes && hl(
          "p",
          i18n.recap.puzzlesHelpedTagging.asArray(hl("strong", animateNumber2(r.puzzles.votes.themes)))
        )
      ])
    ] : [
...
var sources = (r) => {
  ...
  const best = all.map(([k, n]) => [n, r.games.sources[k] || 0]);
  best.sort((a, b) => b[1] - a[1]);
  return best[0] && slideTag("sources")([
    ...
    hl(
      ...
      hl(
        "tbody",
        best.map(
          ([n, c]) => c > 0 && hl("tr", [hl("td", n), hl("td", i18n.site.nbGames.asArray(c, hl("strong", animateNumber2(c))))])
        )
      )
    )
  ]);
    ...
    hl(
      ...
      hl(
        ...
        r.games.perfs.map(
          (p) => hl("tr", [
            hl("td", renderPerf(p)),
            hl("td", i18n.site.nbGames.asArray(p.games, hl("strong", animateNumber2(p.games))))
          ])
        )
      )
    )
...
var lichessGames = (r) => {
  ...
  return slideTag("lichess-games")([
    hl(
      "div.recap--massive",
      i18n.recap.lichessGamesPlayedIn.asArray(hl("strong", animateNumber2(totalGames)), r.year)
    ),
    hl(
      "div",
      hl(
...
var patron = (opts) => slideTag("patron")([
  ...
  opts.user.patron ? hl("p", i18n.patron.thankYou) : hl(
    "p.cta",
...
var renderPerf = (perf) => {
  return hl("span", [
    icon(perfIcons_default[perf.key])(".text"),
    !perfIsSpeed(perf.key) ? i18n.variant[perf.key] : perf.key !== "ultraBullet" ? i18n.site[perf.key] : perf.key
  ]);
};
var stat = (value, label) => hl("div.stat", [hl("div", hl("strong", value)), hl("div", hl("small", label))]);
var stati18n = (value, plural) => {
  const [_, num, label] = plural.asArray(value, hl("strong", numberFormat(value)));
  return hl("div.stat", [hl("div", num), hl("div", hl("small", label))]);
};
var shareable = (r) => {
  var _a;
  return slideTag("shareable")([
    hl("div.recap__shareable", [
      ...
      hl("div.grid", [
        ...
        ((_a = r.games.perfs[0]) == null ? void 0 : _a.games) && stat(renderPerf(r.games.perfs[0]), perfLabel(r.games.perfs[0])),
        r.games.opponents.length && stat(opponentLink(r.games.opponents[0].value), i18n.recap.shareableMostPlayedOpponent),
        stati18n(r.puzzles.nbs.total, i18n.recap.shareableNbPuzzlesSolved)
      ]),
      hl(
        "div.openings",
        COLORS.map(
          (c) => r.games.openings[c].count && stat(r.games.openings[c].value.name, i18n.site[c === "white" ? "asWhite" : "asBlack"])
        )
      )
    ])
  ]);
};
var slideTag = (key, millis = 5e3) => (content) => hl(
...
var animateNumber2 = (n) => hl("span.animated-number", { attrs: { "data-value": n } }, "0");
var animateTime = (n) => hl("span.animated-time", { attrs: { "data-value": n } }, "");
var showGrams = (g) => g > 2e4 ? hl("span", i18n.recap.nbKilograms.asArray(Math.round(g / 1e3), animateNumber2(g / 1e3))) : hl("span", i18n.recap.nbGrams.asArray(g, animateNumber2(g)));

// ../recap/src/view.ts
function awaiter(user) {
  return hl("div#recap-swiper.swiper.swiper-initialized", [hl("div.swiper-wrapper", [loading(user)])]);
}
function view(r, opts) {
...
async function initModule(opts) {
  ...
  const getEl = () => document.querySelector("#recap-swiper");
  if (opts.recap) {
    patch(getEl(), view(opts.recap, opts));
    makeSwiper(opts)(getEl());
  } else {
    patch(getEl(), awaiter(opts.user));
    const loaded = await json(location.pathname);
    initModule(loaded);
  }
}
export {
...
//# sourceMappingURL=recap.OTYVEKAO.js.map
