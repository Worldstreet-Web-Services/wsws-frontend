...
export default function Frontier({ hackathon }: { hackathon: Hackathon }) {
  ...
  return (
    <Default
      ...
      meta={
        <Meta
          title="Frontier | TSION Earn"
          description="TSION Frontier Online Hackathon"
...
const faqs: { question: string; answer: string }[] = [
  {
    ...
    answer:
      'Sidetracks are extra challenges hosted by TSION Earn, separate from Colosseum’s Frontier tracks. They offer additional opportunities to build unique projects and win special prizes.',
  },
  {
...
export const getServerSideProps: GetServerSideProps = async () => {
  const hackathon = await fetchHackathonPublicStats('frontier');
  if (!hackathon.startDate || !hackathon.deadline) {
