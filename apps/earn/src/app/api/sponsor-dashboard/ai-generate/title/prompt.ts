...
*   **Guidance for Bounty/Task (Type: ${type})**
    ...
    *   **Deliverable & Subject Focus:** Clearly state the *primary deliverable* (e.g., 'Twitter thread', 'Landing Page Mockup', 'Blog Post', 'Telegram Bot') and its *core subject* or purpose (e.g., 'TSION Wallet features', 'Web3 Wallets', 'API Integration', 'Payouts'). Be very specific based *only* on the description. If a specific format (like 'thread', 'post', 'script', 'mockup') is mentioned or implied, include it.
    *   **Grammar:** Keep the grammar intact and accurate.
    *   *Example Bounty Titles:*
        *   Write a Twitter Thread Explaining TSION Wallet Features
