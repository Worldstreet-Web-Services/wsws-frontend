...
import { ListingTable } from '@earn/features/sponsor-dashboard/components/ListingTable';
...
import { dashboardQuery } from '@earn/features/sponsor-dashboard/queries/dashboard';
import { sponsorStatsQuery } from '@earn/features/sponsor-dashboard/queries/sponsor-stats';
      ...
      <div className="mb-4 flex w-full flex-col justify-between gap-2 lg:flex-row lg:items-center">
        ...
        <div className="flex w-full items-center gap-2 lg:justify-end">
          ...
          <div className="relative w-64 lg:w-35 xl:w-64">
            ...
            <Input
              className="focus-visible:ring-brand-grey h-9 rounded-lg border-slate-300 bg-white pl-9 font-normal placeholder:text-xs placeholder:text-slate-500"
