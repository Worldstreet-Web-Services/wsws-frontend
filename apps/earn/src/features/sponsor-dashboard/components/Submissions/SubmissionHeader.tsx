...
import { ShinyButton } from '@earn/components/shared/ShinyButton';
import {
  Breadcrumb,
  BreadcrumbItem,
  BreadcrumbLink,
  BreadcrumbList,
} from '@earn/components/ui/breadcrumb';
...
import { SubmissionLabels, SubmissionStatus } from '@earn/prisma/enums';
...
import { isDeadlineOver } from '@earn/features/listings/utils/deadline';
...
import { VerifyPaymentModal } from '@earn/features/sponsor-dashboard/components/Modals/VerifyPayment';
    ...
    <div className="mb-2 flex items-center justify-between gap-12">
                ...
                <div className="my-2 flex w-52">
                  <p className="text-xxs text-red-400">
                    ...
                    <a
                      ...
                      target="_blank"
                      rel="noreferrer"
                      className="text-brand-grey underline"
                    >
                      Reach out
                    </a>{' '}
      ...
      {activeTab === 'payments' &&
        ...
        bountyStatus !== 'Completed' && (
          <Button
            className={cn(
              'border-brand-grey text-brand-grey hover:bg-brand-grey shadow-md hover:text-white',
            )}
