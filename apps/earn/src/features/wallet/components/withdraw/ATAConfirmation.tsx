...
import { useToken } from '@earn/constants/tokenList';
        ...
        <div>
          ...
          {isInsufficient ? (
            ...
            <p className="mt-1 text-sm text-slate-700">
              ...
              small, one-time account setup fee, which is being deducted from
              your current withdrawal. After this setup, future{' '}
              {token} withdrawals to this wallet address won’t require
              additional fees. Read more{' '}
              <a
                href={setupExplanationLink}
                target="_blank"
                className="underline"
              >
                here
