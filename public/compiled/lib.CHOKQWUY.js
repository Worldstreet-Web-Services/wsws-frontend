...
// ../../node_modules/.pnpm/@yaireo+tagify@4.17.9_prop-types@15.8.1/node_modules/@yaireo/tagify/dist/tagify.min.js
var require_tagify_min = __commonJS({
  "../../node_modules/.pnpm/@yaireo+tagify@4.17.9_prop-types@15.8.1/node_modules/@yaireo/tagify/dist/tagify.min.js"(exports, module) {
    !(function(t, e) {
      ...
      var s = "\u200B";
      const a = (t2, e2, i2, s2) => (t2 = "" + t2, e2 = "" + e2, s2 && (t2 = t2.trim(), e2 = e2.trim()), i2 ? t2 == e2 : t2.toLowerCase() == e2.toLowerCase()), n = (t2, e2) => t2 && Array.isArray(t2) && t2.map(((t3) => o(t3, e2)));
      function o(t2, e2) {
        var i2, s2 = {};
      ...
      function p(t2, e2, i2) {
        function s2(t3, e3) {
          for (var i3 in e3) if (e3.hasOwnProperty(i3)) {
            if (g(e3[i3])) {
              g(t3[i3]) ? s2(t3[i3], e3[i3]) : t3[i3] = Object.assign({}, e3[i3]);
              continue;
            }
      ...
      function c() {
        const t2 = [], e2 = {};
        for (let i2 of arguments) for (let s2 of i2) g(s2) ? e2[s2.value] || (t2.push(s2), e2[s2.value] = 1) : t2.includes(s2) || t2.push(s2);
        return t2;
      }
      function u(t2) {
      ...
      function w(t2, e2, i2) {
        return t2 ? (e2 && (t2.__tagifyTagData = i2 ? e2 : p({}, t2.__tagifyTagData || {}, e2)), t2.__tagifyTagData) : (console.warn("tag element doesn't exist", t2, e2), e2);
      }
      function b(t2) {
        if (t2 && t2.parentNode) {
      ...
      function y(t2, e2) {
        t2.forEach(((t3) => {
          if (w(t3.previousSibling) || !t3.previousSibling) {
            var i2 = document.createTextNode(s);
            t3.before(i2), e2 && b(i2);
          }
        }));
      }
      ...
      var D = { refs() {
        ...
        var e2, i2, s2, n2 = this.settings, o2 = "mix" == n2.mode && !n2.enforceWhitelist, r2 = !n2.whitelist || !n2.whitelist.length, l2 = "manual" == n2.dropdown.position;
        if (t2 = void 0 === t2 ? this.state.inputText : t2, !(r2 && !o2 && !n2.templates.dropdownItemNoMatch || false === n2.dropdown.enable || this.state.isLoading || this.settings.readonly)) {
          if (clearTimeout(this.dropdownHide__bindEventsTimeout), this.suggestedListItems = this.dropdown.filterListItems(t2), t2 && !this.suggestedListItems.length && (this.trigger("dropdown:noMatch", t2), n2.templates.dropdownItemNoMatch && (s2 = n2.templates.dropdownItemNoMatch.call(this, { value: t2 }))), !s2) {
            if (this.suggestedListItems.length) t2 && o2 && !this.state.editing.scope && !a(this.suggestedListItems[0].value, t2) && this.suggestedListItems.unshift({ value: t2 });
            else {
            ...
            i2 = "" + (g(e2 = this.suggestedListItems[0]) ? e2.value : e2), n2.autoComplete && i2 && 0 == i2.indexOf(t2) && this.input.autocomplete.suggest.call(this, e2);
          }
          this.dropdown.fill(s2), n2.dropdown.highlightFirst && this.dropdown.highlightOption(this.DOM.dropdown.content.querySelector(n2.classNames.dropdownItemSelector)), this.state.dropdown.visible || setTimeout(this.dropdown.events.binding.bind(this)), this.state.dropdown.visible = t2 || true, this.state.dropdown.query = t2, this.setStateSelection(), l2 || setTimeout((() => {
        ...
        if ("manual" != e2.position) {
          ...
          if (t2 = t2 || l2.clientHeight, this.state.dropdown.visible) {
            if ("text" == u2 ? (a2 = (i2 = (function() {
              ...
              for (var e3 = 0, i3 = 0; t3 && t3 != p2; ) e3 += t3.offsetLeft || 0, i3 += t3.offsetTop || 0, t3 = t3.parentNode;
          ...
          switch (t2.key) {
            ...
            case "Enter":
              t2.preventDefault(), this.settings.hooks.suggestionClick(t2, { tagify: this, tagData: i2, suggestionElm: e2 }).then((() => {
                if (e2) return this.dropdown.selectOption(e2), e2 = this.dropdown.getNextOrPrevOption(e2, !a2), void this.dropdown.highlightOption(e2);
        ...
        if (!t2) return this.addTags(this.state.inputText, true), void (a2 && this.dropdown.hide());
        e2 = e2 || {};
        var n2 = t2.getAttribute("value"), o2 = "noMatch" == n2, r2 = this.suggestedListItems.find(((t3) => {
          var _a;
          return ((_a = t3.value) != null ? _a : t3) == n2;
        }));
        this.trigger("dropdown:select", { data: r2, elm: t2, event: e2 }), n2 && (r2 || o2) ? (this.state.editing ? this.onEditTagDone(null, p({ __isValid: true }, this.normalizeTags([r2])[0])) : this["mix" == this.settings.mode ? "addMixTags" : "addTags"]([r2 || this.input.raw.call(this)], s2), this.DOM.input.parentNode && (setTimeout((() => {
        ...
        var i2, s2, a2, n2, o2, r2 = this.settings, l2 = r2.dropdown, d2 = (e2 = e2 || {}, []), h2 = [], p2 = r2.whitelist, c2 = l2.maxItems >= 0 ? l2.maxItems : 1 / 0, m2 = l2.searchKeys, v2 = 0;
        if (!(t2 = "select" == r2.mode && this.value.length && this.value[0][r2.tagTextProp] == t2 ? "" : t2) || !m2.length) return d2 = l2.includeSelectedTags ? p2 : p2.filter(((t3) => !this.isTagDuplicate(g(t3) ? t3.value : t3))), this.state.dropdown.suggestions = d2, d2.slice(0, c2);
        function f2(t3, e3) {
        ...
        for (o2 = l2.caseSensitive ? "" + t2 : ("" + t2).toLowerCase(); v2 < p2.length; v2++) {
          ...
          let c3 = !Object.keys(i2).some(((t4) => m2.includes(t4))) ? ["value"] : m2;
          l2.fuzzySearch && !e2.exact ? (a2 = c3.reduce(((t4, e3) => t4 + " " + (i2[e3] || "")), "").toLowerCase().trim(), l2.accentedSearch && (a2 = u(a2), o2 = u(o2)), t3 = 0 == a2.indexOf(o2), r3 = a2 === o2, s2 = f2(a2, o2)) : (t3 = true, s2 = c3.some(((t4) => {
            var s3 = "" + (i2[t4] || "");
            return l2.accentedSearch && (s3 = u(s3), o2 = u(o2)), l2.caseSensitive || (s3 = s3.toLowerCase()), r3 = s3 === o2, e2.exact ? s3 === o2 : 0 == s3.indexOf(o2);
          }))), n2 = !l2.includeSelectedTags && this.isTagDuplicate(g(i2) ? i2.value : i2), s2 && !n2 && (r3 && t3 ? h2.push(i2) : "startsWith" == l2.sortby && t3 ? d2.unshift(i2) : d2.push(i2));
        }
        return this.state.dropdown.suggestions = h2.concat(d2), "function" == typeof l2.sortby ? l2.sortby(h2.concat(d2), o2) : h2.concat(d2).slice(0, c2);
      }, getMappedValue(t2) {
        var e2 = this.settings.dropdown.mapValueTo;
        return e2 ? "function" == typeof e2 ? e2(t2) : t2[e2] || t2.value : t2.value;
      }, createListHTML(t2) {
        return p([], t2).map(((t3, i2) => {
          "string" != typeof t3 && "number" != typeof t3 || (t3 = { value: t3 });
          var s2 = this.dropdown.getMappedValue(t3);
          return s2 = "string" == typeof s2 ? h(s2) : s2, this.settings.templates.dropdownItem.apply(this, [e(e({}, t3), {}, { mappedValue: s2 }), this]);
        })).join("");
      } };
      const M = "@yaireo/tagify/";
      var I, N = { empty: "empty", exceed: "number of tags exceeded", pattern: "pattern mismatch", duplicate: "already exists", notAllowed: "not allowed" }, S = { wrapper: (t2, e2) => `<tags class="${e2.classNames.namespace} ${e2.mode ? `${e2.classNames[e2.mode + "Mode"]}` : ""} ${t2.className}"
      ...
      var E = { customBinding() {
        ...
        var e2, i2 = document.activeElement, s2 = f.call(this, i2) && this.DOM.scope.contains(document.activeElement), a2 = s2 && i2.hasAttribute("readonly");
        ...
        if (!this.state.composing && e2.userInput) {
          ...
          if (this.trigger("keydown", { event: t2 }), "mix" == e2.mode) {
            switch (t2.key) {
              ...
              case "Backspace":
                ...
                var s2 = document.getSelection(), a2 = "Delete" == t2.key && s2.anchorOffset == (s2.anchorNode.length || 0), n2 = s2.anchorNode.previousSibling, o2 = 1 == s2.anchorNode.nodeType || !s2.anchorOffset && n2 && 1 == n2.nodeType && s2.anchorNode.previousSibling;
                r(this.DOM.input.innerHTML);
                var l2, h2, g2, p2 = this.getTagElms(), c2 = 1 === s2.anchorNode.length && s2.anchorNode.nodeValue == String.fromCharCode(8203);
                if ("edit" == e2.backspace && o2) return l2 = 1 == s2.anchorNode.nodeType ? null : s2.anchorNode.previousElementSibling, setTimeout(this.editTag.bind(this), 0, l2), void t2.preventDefault();
                if (m() && o2 instanceof Element) return g2 = d(o2), o2.hasAttribute("readonly") || o2.remove(), this.DOM.input.focus(), void setTimeout((() => {
                  b(g2), this.DOM.input.click();
                }));
                if ("BR" == s2.anchorNode.nodeName) return;
                if ((a2 || o2) && 1 == s2.anchorNode.nodeType ? h2 = 0 == s2.anchorOffset ? a2 ? p2[0] : null : p2[Math.min(p2.length, s2.anchorOffset) - 1] : a2 ? h2 = s2.anchorNode.nextElementSibling : o2 instanceof Element && (h2 = o2), 3 == s2.anchorNode.nodeType && !s2.anchorNode.nodeValue && s2.anchorNode.previousElementSibling && t2.preventDefault(), (o2 || a2) && !e2.backspace) return void t2.preventDefault();
                if ("Range" != s2.type && !s2.anchorOffset && s2.anchorNode == this.DOM.input && "Delete" != t2.key) return void t2.preventDefault();
                if ("Range" != s2.type && h2 && h2.hasAttribute("readonly")) return void b(d(h2));
                "Delete" == t2.key && c2 && w(s2.anchorNode.nextSibling) && this.removeTags(s2.anchorNode.nextSibling), clearTimeout(I), I = setTimeout((() => {
                  var t3 = document.getSelection();
                  r(this.DOM.input.innerHTML), !a2 && t3.anchorNode.previousSibling, this.value = [].map.call(p2, ((t4, e3) => {
                    var i3 = w(t4);
          ...
          switch (t2.key) {
            ...
            case "Enter":
              if (this.state.dropdown.visible && "manual" != e2.dropdown.position) return;
        ...
        var e2, i2, s2, a2, n2, o2, r2, l2, d2 = this.settings, h2 = this.value.length, g2 = this.getTagElms(), c2 = document.createDocumentFragment(), u2 = window.getSelection().getRangeAt(0), v2 = [].map.call(g2, ((t3) => w(t3).value));
        if ("deleteContentBackward" == t2.inputType && m() && this.events.callbacks.onKeydown.call(this, { target: t2.target, key: "Backspace" }), y(this.getTagElms()), this.value.slice().forEach(((t3) => {
          t3.readonly && !v2.includes(t3.value) && c2.appendChild(this.createTagElem(t3));
        })), c2.childNodes.length && (u2.insertNode(c2), this.setRangeAtStartEnd(false, c2.lastChild)), g2.length != h2) return this.value = [].map.call(this.getTagElms(), ((t3) => w(t3))), void this.update({ withoutChangeEvent: true });
        if (this.hasMaxTags()) return true;
        if (window.getSelection && (o2 = window.getSelection()).rangeCount > 0 && 3 == o2.anchorNode.nodeType) {
          if ((u2 = o2.getRangeAt(0).cloneRange()).collapse(true), u2.setStart(o2.focusNode, 0), s2 = (e2 = u2.toString().slice(0, u2.endOffset)).split(d2.pattern).length - 1, (i2 = e2.match(d2.pattern)) && (a2 = e2.slice(e2.lastIndexOf(i2[i2.length - 1]))), a2) {
        ...
        setTimeout((() => {
          this.update({ withoutChangeEvent: true }), this.trigger("input", p({}, this.state.tag, { textContent: this.DOM.input.textContent })), this.state.tag && this.dropdown[n2 ? "show" : "hide"](this.state.tag.value);
        }), 10);
      }, onInputIE(t2) {
        var e2 = this;
        setTimeout((function() {
        ...
        var i2 = t2.closest("." + this.settings.classNames.tag), s2 = this.getNodeIndex(i2), a2 = w(i2), n2 = this.input.normalize.call(this, t2), o2 = { [this.settings.tagTextProp]: n2, __tagId: a2.__tagId }, r2 = this.validateTag(o2);
        this.editTagChangeDetected(p(a2, o2)) || true !== t2.originalIsValid || (r2 = true), i2.classList.toggle(this.settings.classNames.tagInvalid, true !== r2), a2.__isValid = r2, i2.title = true === r2 ? a2.title || a2.value : r2, n2.length >= this.settings.dropdown.enabled && (this.state.editing && (this.state.editing.value = n2), this.dropdown.show(n2)), this.trigger("edit:input", { tag: i2, index: s2, data: p({}, this.value[s2], { newValue: n2 }), event: e2 });
        ...
        if (this.state.hasFocus || this.toggleFocusClass(), this.DOM.scope.contains(t2)) {
          var e2, i2, s2 = this.settings, a2 = t2.closest("." + s2.classNames.tag), n2 = w(a2), o2 = this.input.normalize.call(this, t2), r2 = { [s2.tagTextProp]: o2, __tagId: n2.__tagId }, l2 = n2.__originalData, d2 = this.editTagChangeDetected(p(n2, r2)), h2 = this.validateTag(r2);
          if (o2) if (d2) {
            if (e2 = this.hasMaxTags(), i2 = p({}, l2, { [s2.tagTextProp]: this.trim(o2), __isValid: h2 }), s2.transformTag.call(this, i2, l2), true !== (h2 = (!e2 || true === l2.__isValid) && this.validateTag(i2))) {
        ...
        var e2, i2, s2 = t2.target.closest("." + this.settings.classNames.tag), a2 = w(s2), n2 = this.settings;
        s2 && n2.userInput && false !== a2.editable && (e2 = s2.classList.contains(this.settings.classNames.tagEditing), i2 = s2.hasAttribute("readonly"), "select" == n2.mode || n2.readonly || e2 || i2 || !this.settings.editTags || this.editTag(s2), this.toggleFocusClass(true), this.trigger("dblclick", { tag: s2, index: this.getNodeIndex(s2), data: w(s2) }));
      }, onInputDOMChange(t2) {
        t2.forEach(((t3) => {
          t3.addedNodes.forEach(((t4) => {
            ...
            if ("<div><br></div>" == t4.outerHTML) t4.replaceWith(document.createElement("br"));
              ...
              3 == t4.childNodes[0].nodeType && "BR" != t4.previousSibling.nodeName && (e3 = document.createTextNode("\n")), t4.replaceWith(e3, ...[...t4.childNodes].slice(0, -1)), b(e3);
            } else if (f.call(this, t4)) if (3 != ((_a = t4.previousSibling) == null ? void 0 : _a.nodeType) || t4.previousSibling.textContent || t4.previousSibling.remove(), t4.previousSibling && "BR" == t4.previousSibling.nodeName) {
              t4.previousSibling.replaceWith("\n" + s);
              let e3 = t4.nextSibling, i2 = "";
              for (; e3; ) i2 += e3.textContent, e3 = e3.nextSibling;
              i2.trim() && b(t4.previousSibling);
            } else t4.previousSibling && !w(t4.previousSibling) || t4.before(s);
          })), t3.removedNodes.forEach(((t4) => {
            t4 && "BR" == t4.nodeName && f.call(this, e2) && (this.removeTags(e2), this.fixFirefoxLastTagNoCaret());
          }));
        }));
      ...
      function _(t2, e2) {
        ...
        p(this, (function(t3) {
          ...
          return { off(t4, e4) {
            ...
            if (a2 = a2 || { cloneData: true }, i4) if (t3.settings.isJQueryPlugin) "remove" == i4 && (i4 = "removeTag"), jQuery(t3.DOM.originalInput).triggerHandler(i4, [s2]);
              ...
              try {
                ...
                if ((o2 = a2.cloneData ? p({}, o2) : o2).tagify = this, s2.event && (o2.event = this.cloneEvent(s2.event)), s2 instanceof Object) for (var r2 in s2) s2[r2] instanceof HTMLElement && (o2[r2] = s2[r2]);
          ...
          let e3, s2 = "/" + t3;
          if (1 == localStorage.getItem(M + i2 + "/v", 1)) try {
            e3 = JSON.parse(localStorage[M + i2 + s2]);
          } catch (t4) {
          }
          return e3;
        }), this.setPersistedData = ((t3) => t3 ? (localStorage.setItem(M + t3 + "/v", 1), (e3, i3) => {
          let s2 = "/" + i3, a2 = JSON.stringify(e3);
          e3 && i3 && (localStorage.setItem(M + t3 + s2, a2), dispatchEvent(new Event("storage")));
        }) : () => {
      ...
      return _.prototype = { _dropdown: D, getSetTagData: w, helpers: { sameStr: a, removeCollectionProp: n, omit: o, isObject: g, parseHTML: l, escapeHTML: h, extend: p, concatWithoutDups: c, getUID: v, isNodeTag: f }, customEventsList: ["change", "add", "remove", "invalid", "input", "click", "keydown", "focus", "blur", "edit:input", "edit:beforeUpdate", "edit:updated", "edit:start", "edit:keydown", "dropdown:show", "dropdown:hide", "dropdown:select", "dropdown:updated", "dropdown:noMatch", "dropdown:scroll"], dataProps: ["__isValid", "__removed", "__originalData", "__originalHTML", "__tagId"], trim(t2) {
        ...
        var s2 = p({}, x, "mix" == i2.mode ? { dropdown: { position: "text" } } : {}), a2 = this.settings = p({}, s2, i2);
        if (a2.disabled = t2.hasAttribute("disabled"), a2.readonly = a2.readonly || t2.hasAttribute("readonly"), a2.placeholder = h(t2.getAttribute("placeholder") || a2.placeholder || ""), a2.required = t2.hasAttribute("required"), this.generateClassSelectors(a2.classNames), void 0 === a2.dropdown.includeSelectedTags && (a2.dropdown.includeSelectedTags = a2.duplicates), this.isIE && (a2.autoComplete = false), ["whitelist", "blacklist"].forEach(((e2) => {
          var i3 = t2.getAttribute("data-" + e2);
          i3 && (i3 = i3.split(a2.delimiters)) instanceof Array && (a2[e2] = i3);
        })), "autoComplete" in i2 && !g(i2.autoComplete) && (a2.autoComplete = x.autoComplete, a2.autoComplete.enabled = i2.autoComplete), "mix" == a2.mode && (a2.pattern = a2.pattern || /@/, a2.autoComplete.rightKey = true, a2.delimiters = i2.delimiters || null, a2.tagTextProp && !a2.dropdown.searchKeys.includes(a2.tagTextProp) && a2.dropdown.searchKeys.push(a2.tagTextProp)), t2.pattern) try {
        ...
        a2.disabled && (a2.userInput = false), this.TEXTS = e(e({}, N), a2.texts || {}), ("select" != a2.mode || ((_a = i2.dropdown) == null ? void 0 : _a.enabled)) && a2.userInput || (a2.dropdown.enabled = 0), a2.dropdown.appendTarget = ((_b = i2.dropdown) == null ? void 0 : _b.appendTarget) || document.body;
        let n2 = this.getPersistedData("whitelist");
        Array.isArray(n2) && (this.whitelist = Array.isArray(a2.whitelist) ? c(a2.whitelist, n2) : n2);
      }, getAttributes(t2) {
        ...
        if (!g(t2)) return "";
        var e2, i2 = {};
        for (e2 in t2) "__" != e2.slice(0, 2) && "class" != e2 && t2.hasOwnProperty(e2) && void 0 !== t2[e2] && (i2[e2] = h(t2[e2]));
        return i2;
      }, setStateSelection() {
      ...
      }, events: E, fixFirefoxLastTagNoCaret() {
        ...
        this.getTagTextNode(t2).innerHTML = h(e2);
      }, editTag(t2, e2) {
        t2 = t2 || this.getLastTag(), e2 = e2 || {}, this.dropdown.hide();
        var i2 = this.settings, s2 = this.getTagTextNode(t2), a2 = this.getNodeIndex(t2), n2 = w(t2), o2 = this.events.callbacks, r2 = this, l2 = true;
        if (s2) {
          if (!(n2 instanceof Object && "editable" in n2) || n2.editable) return n2 = w(t2, { __originalData: p({}, n2), __originalHTML: t2.cloneNode(true) }), w(n2.__originalHTML, n2.__originalData), s2.setAttribute("contenteditable", true), t2.classList.add(i2.classNames.tagEditing), s2.addEventListener("focus", o2.onEditTagFocus.bind(this, t2)), s2.addEventListener("blur", (function() {
        ...
        e2 = e2 || {};
        var i2 = { tag: t2 = t2 || this.state.editing.scope, index: this.getNodeIndex(t2), previousData: w(t2), data: e2 };
        ...
        e2 && e2.value || (e2 = t2.__tagifyTagData), e2.__isValid && 1 != e2.__isValid && p(e2, this.getInvalidTagAttrs(e2, e2.__isValid));
        ...
        this.value.length = 0, [].forEach.call(this.getTagElms(), ((t2) => {
          t2.classList.contains(this.settings.classNames.tagNotAllowed.split(" ")[0]) || this.value.push(w(t2));
        })), this.update();
      }, injectAtCaret(t2, e2) {
        var _a;
        return !(e2 = e2 || ((_a = this.state.selection) == null ? void 0 : _a.range)) && t2 ? (this.appendMixTags(t2), this) : (T(t2, e2), this.setRangeAtStartEnd(false, t2), this.updateValueByDOMTags(), this.update(), this);
      }, input: { set() {
        ...
        this.state.inputText = t2, e2 && (this.DOM.input.innerHTML = h("" + t2)), !t2 && i2 && this.dropdown.hide.bind(this), this.input.autocomplete.suggest.call(this), this.input.validate.call(this);
      }, raw() {
        ...
        for (let n2 of this.value) {
          a(this.trim("" + t2), n2.value, e2) && i2 != n2.__tagId && s2++;
        }
        return s2;
      }, getTagIndexByValue(t2) {
        var e2 = [], i2 = this.settings.dropdown.caseSensitive;
        return this.getTagElms().forEach(((s2, n2) => {
          s2.__tagifyTagData && a(this.trim(s2.__tagifyTagData.value), t2, i2) && e2.push(n2);
        })), e2;
      }, getTagElmByValue(t2) {
        ...
        e2 = e2 || "value";
        var s2, n2 = this.settings;
        return (i2 = i2 || n2.whitelist).some(((i3) => {
          var o2 = "string" == typeof i3 ? i3 : i3[e2] || i3.value;
          if (a(o2, t2, n2.dropdown.caseSensitive, n2.trim)) return s2 = "string" == typeof i3 ? { value: i3 } : i3, true;
        })), s2 || "value" != e2 || "value" == n2.tagTextProp || (s2 = this.getWhitelistItem(t2, n2.tagTextProp, i2)), s2;
      }, validateTag(t2) {
        ...
        return d2.forEach(((t3, e3) => w(t3, l2[e3]))), this.update({ withoutChangeEvent: true }), y(d2, this.state.hasFocus), t2;
        ...
        var e2 = p({ value: "" }, t2 || {}), i2 = this.createTagElem(e2);
        w(i2, e2), this.appendTag(i2), this.editTag(i2, { skipValidation: true });
      }, addTags(t2, e2, i2) {
        ...
        return this.DOM.input.removeAttribute("style"), t2.forEach(((t3) => {
          ...
          if (t3 = Object.assign({}, l2), a2.transformTag.call(this, t3), t3.__isValid = this.hasMaxTags() || this.validateTag(t3), true !== t3.__isValid) {
            if (i2) return;
            if (p(r2, this.getInvalidTagAttrs(t3, t3.__isValid), { __preInvalidData: l2 }), t3.__isValid == this.TEXTS.duplicate && this.flashTag(this.getTagElmByValue(t3.value)), !a2.createInvalidTags) return void n2.push(t3.value);
          }
        ...
        return this.state.tag = null, this.trigger("add", p({}, { tag: e2 }, { data: t2 })), e2;
      }, appendTag(t2) {
        var e2 = this.DOM, i2 = e2.input;
        e2.scope.insertBefore(t2, i2);
      }, createTagElem(t2, i2) {
        t2.__tagId = v();
        var s2, a2 = p({}, t2, e({ value: h(t2.value + "") }, i2));
        return (function(t3) {
        ...
        })(s2 = this.parseTemplate("tag", [a2, this])), w(s2, t2), s2;
      }, reCheckInvalidTags() {
        var t2 = this.settings;
        this.getTagElms(t2.classNames.tagNotAllowed).forEach(((e2, i2) => {
          var s2 = w(e2), a2 = this.hasMaxTags(), n2 = this.validateTag(s2), o2 = true === n2 && !a2;
        ...
        if (t2 = t2 && t2 instanceof HTMLElement ? [t2] : t2 instanceof Array ? t2 : t2 ? [t2] : [this.getLastTag()], s2 = t2.reduce(((t3, e3) => {
          ...
          var i3 = w(e3);
          return e3 && i3 && !i3.readonly && t3.push({ node: e3, idx: this.getTagIdx(i3), data: w(e3, { __removed: true }) }), t3;
        ...
        (t2 = Array.isArray(t2) ? t2 : [t2]).forEach(((t3) => {
          var e2 = w(t3), i2 = this.getTagIdx(e2);
        ...
        return n(t2 || this.value, this.dataProps);
        ...
        return (function i3(n2) {
          n2.childNodes.forEach(((n3) => {
            if (1 == n3.nodeType) {
              const r2 = w(n3);
              if ("BR" == n3.tagName && (t2 += "\r\n"), r2 && f.call(e2, n3)) {
                if (r2.__removed) return;
                t2 += a2[0] + s2(o(r2, e2.dataProps)) + a2[1];
              } else n3.getAttribute("style") || ["B", "I", "U"].includes(n3.tagName) ? t2 += n3.textContent : "DIV" != n3.tagName && "P" != n3.tagName || (t2 += "\r\n", i3(n3));
            } else t2 += n3.textContent;
          }));
        })(this.DOM.input), t2;
...
//# sourceMappingURL=lib.CHOKQWUY.js.map
