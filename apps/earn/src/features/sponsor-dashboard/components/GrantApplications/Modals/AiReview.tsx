...
import {
  ...
  AlertDialogHeader,
  AlertDialogTitle,
} from '@earn/components/ui/alert-dialog';
...
import {
  ...
  CardFooter,
  CardHeader,
} from '@earn/components/ui/card';
import {
  Dialog,
  DialogContent,
  DialogTitle,
  DialogTrigger,
} from '@earn/components/ui/dialog';
...
// import { chunkArray } from '@earn/utils/chunkArray';
import {
  type GrantApplicationAi,
  type GrantsAi,
  type GrantWithApplicationCount,
} from '@earn/features/grants/types';
import { useCommitReviewsGrantApplications } from '@earn/features/sponsor-dashboard/mutations/useCommitReviewsGrantApplications';
// import { useReviewApplication } from '@earn/features/sponsor-dashboard/mutations/useReviewApplication';
import { unreviewedGrantApplicationsQuery } from '@earn/features/sponsor-dashboard/queries/unreviewed-grant-applications';
import { type GrantApplicationWithUser } from '@earn/features/sponsor-dashboard/types';
import { colorMap } from '@earn/features/sponsor-dashboard/utils/statusColorMap';
