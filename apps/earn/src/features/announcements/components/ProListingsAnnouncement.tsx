...
import ProGradientIcon from '@earn/components/icons/ProGradientIcon';
import { AnimatedDots } from '@earn/components/shared/AnimatedDots';
...
import { RandomArrow } from '@earn/features/pro/components/RandomArrow';
      ...
      >
        <div className="mx-auto w-full overflow-hidden rounded-lg bg-white shadow-lg">
          ...
          <div className="bg-white px-6 pt-8 pb-6">
            ...
            <Button
              asChild
              className="bg-brand-grey hover:bg-brand-grey/90 w-full rounded-lg text-white"
            >
              <Link
