import {
  ...
  theme,
  userBox
} from "./lib.6KDROPTB.js";
import {
  makeVoiceMove,
  renderVoiceBar
} from "./lib.S3BAIJON.js";
import "./lib.HM2GX7JB.js";
...
import {
  annotationShapes
} from "./lib.3DBOWVDW.js";
import {
  ctrl,
  render
} from "./lib.JG4BZMTE.js";
import {
  menuHover_default
...
var Report = class {
  ...
  checkForMultipleSolutions(ev, ctrl2, threatMode) {
    ...
    pieceCount(ev.fen) <= 7 || !((_b = (_a = ctrl2.ceval.engines.active()) == null ? void 0 : _a.capabilities) == null ? void 0 : _b.includes("puzzleReport")) || // if the user has chosen to hide the dialog less than a week ago
...
//# sourceMappingURL=puzzle.QIJDXJIO.js.map
