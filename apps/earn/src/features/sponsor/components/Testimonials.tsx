      ...
      >
        ...
        <div className="mt-4 grid w-full grid-cols-1 gap-6 md:grid-cols-3">
          <div className="md:col-span-3">
            <TestimonialTile
              hero
              logo={`${SPONSOR_LOGO_BASE}/token-registry-2.webp`}
              logoAlt="Token Registry"
              quote={
                "Earn is the default place for us at Token Registry to find TSION native freelancers. We've been powerusers of it for a while — its distribution to talent is unmatched."
              }
              metrics={{
                views: '2M+',
                submissions: '3000+',
              ...
              personTitle="COO, Token Registry"
              personPfp={`${USER_PFP_BASE}/kash-dhanda.webp`}
            />
          </div>

          <TestimonialTile
            logo={`${SPONSOR_LOGO_BASE}/worldstreet-foundation.webp`}
            logoAlt="TSION"
            quote={
            ...
            personName="Vibhu"
            personTitle="Product Marketing, TSION"
            personPfp={`${USER_PFP_BASE}/vibhu.webp`}
          />

          <TestimonialTile
            logo={`${SPONSOR_LOGO_BASE}/worldstreet.webp`}
            logoAlt="TSION"
            quote={
              'Running a hackathon without TSION Earn is nearly impossible. Earn gave us everything we needed to operate and they provided us with first-class support.'
            }
            metrics={{ views: '250k+', submissions: '200+' }}
            personName="Brady"
            personTitle="BD Lead, TSION"
