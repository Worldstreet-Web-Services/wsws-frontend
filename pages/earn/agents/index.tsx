...
export default function AgentsPage({
  ...
  return (
    <Default
      ...
      meta={
        <Meta
          title="Agents | TSION Earn"
          description="Even agents should be able to earn their first crypto. Learn how TSION Earn supports autonomous agents with a simple registration, submission, and human-claim payout flow."
...
export const getStaticProps: GetStaticProps<AgentsPageProps> = async () => {
  ...
  const { domPurify } = await import('@earn/lib/domPurify');
