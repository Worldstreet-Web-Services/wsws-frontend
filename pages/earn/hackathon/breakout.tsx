...
import { TrackBox } from '@earn/components/hackathon/TrackBox';
import { CountDownRenderer } from '@earn/components/shared/countdownRenderer';
import {
  Accordion,
  AccordionContent,
  AccordionItem,
...
import { type TrackProps } from '@earn/interface/hackathon';
import { Default } from '@earn/layouts/Default';
import { Meta } from '@earn/layouts/Meta';
import { domPurify } from '@earn/lib/domPurify';
import { fetchHackathonPublicStats } from '@earn/lib/earn-public-data';
import {
  type Stats,
  statsDataQuery,
  trackDataQuery,
} from '@earn/queries/hackathon';
import { BreakoutLogo } from '@earn/svg/breakout-logo';
import { PulseIcon } from '@earn/svg/pulse-icon';
...
const animeAce = localFont({
  src: [
    {
      path: '../../../apps/earn/src/theme/animeace2_reg.ttf',
      weight: '400',
      style: 'normal',
    },
    {
      path: '../../../apps/earn/src/theme/animeace2_ital.ttf',
      weight: '400',
      style: 'italic',
    },
    {
      path: '../../../apps/earn/src/theme/animeace2_bld.ttf',
      weight: '700',
      style: 'normal',
    },
  ],
    ...
    <Default
      ...
      meta={
        <>
          ...
          />
          <Meta
            title="Breakout | TSION Earn"
            description={`TSION Breakout Online Hackathon`}
...
const faqs: { question: string; answer: string }[] = [
  {
    ...
    answer:
      'Sidetracks are extra challenges hosted by TSION Earn, separate from Colosseum’s Breakout tracks. They offer additional opportunities to build unique projects and win special prizes.',
  },
  {
    question: 'Do I need to submit separately to Sidetracks on TSION Earn?',
    answer:
      'Yes! Sidetracks have their own submission process on TSION Earn. Make sure you submit your project directly to each Sidetrack you wish to enter.',
  },
  {
  ...
  },
  {
    ...
    answer:
      'Check out <a href="https://www.colosseum.org/radar/resources" target="_blank">Colosseum’s Developer Resources page</a>. You’ll find documentation, tools, tutorials, and everything you need to build on TSION.',
  },
  {
...
export const getServerSideProps: GetServerSideProps = async ({}) => {
  const hackathon = await fetchHackathonPublicStats('breakout');
  if (!hackathon.startDate || !hackathon.deadline) {
