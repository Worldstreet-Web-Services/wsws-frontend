...
import { getSiteUrl, isProductionEnv } from '@earn/lib/site-url';
import { prisma } from '@earn/prisma';
import { getChapterRegions } from '@earn/utils/chapterRegion';

import { getAllCategorySlugs } from '@earn/features/listings/utils/category';
import {
...
import {
  getAllSkillSlugs,
  getParentSkillSlugs,
} from '@earn/features/listings/utils/skill';
