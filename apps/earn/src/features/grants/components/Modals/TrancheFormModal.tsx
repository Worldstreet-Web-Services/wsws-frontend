...
import { MultiImageUploader } from '@earn/components/shared/MultiImageUploader';
...
import { validateWalletAddress } from '@earn/utils/validateWalletAddress';
  ...
  return z
    ...
    .superRefine((data, ctx) => {
      if (data.walletAddress) {
        const validate = validateWalletAddress(data.walletAddress);
        if (!validate) {
          ctx.addIssue({
            code: 'custom',
            path: ['walletAddress'],
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem className={cn('flex flex-col gap-2')}>
                  ...
                  <div>
                    <FormControl>
                      <Input placeholder="Add your wallet address" {...field} />
                    </FormControl>
