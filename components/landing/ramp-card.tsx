...
export function RampCard() {
  ...
  return (
    <div className="rounded-[24px] border border-white/18 bg-[rgba(16,16,18,0.62)] p-[26px] shadow-[inset_0_1px_0_rgba(255,255,255,0.25),0_30px_70px_-30px_rgba(0,0,0,0.85)] backdrop-blur-[16px]">
