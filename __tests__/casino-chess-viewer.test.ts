...
describe("resolveViewerColor", () => {
  it("uses the wallet address on normal wallet-backed games", () => {
    expect(resolveViewerColor(match(), "0x235e4742935226A09D79916f9d08f27e16596278", null)).toBeNull();
    expect(
      resolveViewerColor(
        match({
          black: {
  ...
  it("falls back to the carried swiss seat name on managed boards", () => {
    expect(resolveViewerColor(match(), "0x235e4742935226A09D79916f9d08f27e16596278", "0x235e47-6278")).toBe(
      "b"
    );
    expect(resolveViewerColor(match(), "0xDD0737edCc438E4E4F4532E1D3d1cdCBEBae6C2E", "0xDD0737-6C2E")).toBe(
      "w"
    );
  });
});
