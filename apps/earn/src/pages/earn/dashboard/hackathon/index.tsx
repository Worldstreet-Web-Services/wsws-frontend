...
import {
  ...
  DropdownMenuItem,
  DropdownMenuTrigger,
} from '@earn/components/ui/dropdown-menu';
import { Input } from '@earn/components/ui/input';
import { StatusPill } from '@earn/components/ui/status-pill';
import {
  Table,
  TableBody,
  TableCell,
...
import { type ListingWithSubmissions } from '@earn/features/listings/types';
import { formatDeadline } from '@earn/features/listings/utils/deadline';
import { getColorStyles } from '@earn/features/listings/utils/getColorStyles';
import { getListingStatus } from '@earn/features/listings/utils/status';
import { Banner } from '@earn/features/sponsor-dashboard/components/Banner';
import { CreateListingModal } from '@earn/features/sponsor-dashboard/components/CreateListingModal';
import { ListingTableSkeleton } from '@earn/features/sponsor-dashboard/components/ListingTableSkeleton';
import { activeHackathonsQuery } from '@earn/features/sponsor-dashboard/queries/active-hackathons';
    ...
    <SponsorLayout>
      ...
      <div className="mb-4 flex w-full justify-between">
        ...
        <div className="relative w-64">
          ...
          <Input
            className="placeholder:text-md focus-visible:ring-brand-grey border-slate-200 bg-white pl-9 placeholder:font-medium placeholder:text-slate-400"
                      ...
                      <TableCell className="px-3 py-2">
                        {currentBounty.status === 'OPEN' &&
                          currentBounty.isPublished && (
                            ...
                            >
                              <Button
                                className="text-brand-grey text-[13px] font-medium hover:bg-indigo-100"
                                disabled={!hasHackathonStarted}
                                onClick={() =>
