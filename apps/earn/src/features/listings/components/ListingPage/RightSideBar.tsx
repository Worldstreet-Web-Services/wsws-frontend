...
import MdTimer from '@earn/components/icons/MdTimer';
import TbBriefcase2 from '@earn/components/icons/TbBriefcase2';
...
import { exclusiveSponsorData } from '@earn/constants/exclusiveSponsors';
import { useServerTimeSync } from '@earn/hooks/use-server-time';
import { type ParentSkills } from '@earn/interface/skills';
...
import { cleanRewardPrizes } from '@earn/utils/rank';

import { RelatedListings } from '@earn/features/home/components/RelatedListings';
              ...
              <>
                <div className="flex flex-col items-start justify-center">
                  <div className="flex items-center justify-center gap-2">
                    <TbBriefcase2
                      className={cn(
                        isPro ? 'text-zinc-900' : 'text-brand-grey',
                        'size-[1.4rem]',
                      )}
                    />
