...
import { normalizeCanonicalUrl } from '@earn/utils/canonical';
...
import { Comments } from '@earn/features/comments/components/Comments';
import { ListingHeader } from '@earn/features/listings/components/ListingPage/ListingHeader';
import { RightSideBar } from '@earn/features/listings/components/ListingPage/RightSideBar';
import { SubmissionActionButton } from '@earn/features/listings/components/Submission/SubmissionActionButton';
...
import { bountySnackbarAtom } from '@earn/features/navbar/components/BountySnackbar';
    ...
    <Default
      meta={
        <Head>
          ...
          } by ${initialListing?.sponsor?.name} | TSION Earn Listing`}</title>
          <meta
            name="description"
            content={`${getListingTypeLabel(initialListing?.type ?? 'Listing')} on TSION Earn | ${
          ...
          <meta
            property="og:title"
            content={`${initialListing?.title || 'Listing'} | TSION Earn`}
          />
          ...
          <meta
            ...
            content={`${initialListing?.title || 'Listing'} - ${initialListing?.type === 'bounty' ? 'Bounty' : 'Project'} by ${initialListing?.sponsor?.name || 'Sponsor'} on TSION Earn`}
          />
