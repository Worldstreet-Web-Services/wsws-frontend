...
import BiListUl from '@earn/components/icons/BiListUl';
import { type IconType } from '@earn/components/icons/helpers/GenIcon';
import MdList from '@earn/components/icons/MdList';
import MdOutlineChatBubbleOutline from '@earn/components/icons/MdOutlineChatBubbleOutline';
import RiUserSettingsLine from '@earn/components/icons/RiUserSettingsLine';
import { EntityNameModal } from '@earn/components/modals/EntityNameModal';
...
import { SponsorContentSkeleton } from '@earn/layouts/SponsorLayoutSkeleton';
import { useUser } from '@earn/store/user';
import Sparkle from '@earn/svg/sparkle';
import { cn } from '@earn/utils/cn';

import { isAutoGenerateOpenAtom } from '@earn/features/listing-builder/atoms';
import { isCreateListingAllowedQuery } from '@earn/features/listing-builder/queries/is-create-allowed';
import { NavItem } from '@earn/features/sponsor-dashboard/components/NavItems';
import { SelectHackathon } from '@earn/features/sponsor-dashboard/components/SelectHackathon';
import { SelectSponsor } from '@earn/features/sponsor-dashboard/components/SelectSponsor';
...
const ProListingsAnnouncement = dynamic(
  () =>
    import('@earn/features/announcements/components/ProListingsAnnouncement').then(
...
const Login = dynamic(
  () => import('@earn/features/auth/components/Login').then((m) => m.Login),
  { ssr: false },
);

const AutoGenerateDialog = dynamic(
  () =>
    import('@earn/features/listing-builder/components/AutoGenerate/Dialog').then(
...
const CreateListingModal = dynamic(
  () =>
    import('@earn/features/sponsor-dashboard/components/CreateListingModal').then(
...
const SponsorInfoModal = dynamic(
  () =>
    import('@earn/features/sponsor-dashboard/components/SponsorInfoModal').then(
