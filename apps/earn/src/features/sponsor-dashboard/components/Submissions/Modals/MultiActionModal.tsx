...
import { useRejectSubmissions } from '@earn/features/sponsor-dashboard/mutations/useRejectSubmissions';
import { useToggleWinner } from '@earn/features/sponsor-dashboard/mutations/useToggleWinner';
    ...
    switch (actionType) {
      ...
      case 'shortlist':
        return {
          ...
          buttonClass:
            'rounded-lg border border-slate-300 bg-slate-50 text-slate-600 hover:bg-slate-100',
