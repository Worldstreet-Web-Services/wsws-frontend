...
const SponsorListingsPage = ({ sponsor, title }: Props) => {
  ...
  return (
    <Default
      ...
      meta={
        <Head>
          <title>{`${title} Opportunities | TSION Earn`}</title>
          <meta
            name="description"
            content={`
...
`}
          ...
          <meta property="og:title" content={`${title} on TSION Earn`} />
          <meta property="og:image" content={ogImage.toString()} />
          <meta name="twitter:title" content={`${title} on TSION Earn`} />
