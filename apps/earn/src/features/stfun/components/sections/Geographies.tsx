...
export default function Geographies({ chapters }: GeographiesProps) {
  ...
  return (
    ...
    >
      ...
      <p className="sr-only">
        Discover Superteam chapters worldwide - TSION and Web3 talent
                ...
                <li key={superteam.slug} className="contents">
                  {hasLink ? (
                    <a
                      ...
                      aria-label={`${superteam.name} - TSION community in ${superteam.country[0] || superteam.displayValue}`}
      ...
      <noscript>
        <div className="mx-auto max-w-[1200px] px-4 py-8">
          <h3 className="mb-4 text-lg font-semibold text-white">
            Superteam Locations - Global Web3 &amp; TSION Communities
          </h3>
