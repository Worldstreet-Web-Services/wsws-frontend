...
export function generateListingQuestionsPrompt(
  ...
  let prompt = `Analyze the following listing description for a '${type}' on platform TSION Earn. Your goal is to generate relevant custom questions for the application/submission form, following the specific rules for the listing type.
