...
// ../bits/src/bits.qrcode.ts
var import_qrcode = __toESM(require_browser(), 1);
var qrs = document.querySelectorAll("canvas.qrcode");
for (const qr of qrs) {
  if (!qr.dataset.qrUrl) continue;
  import_qrcode.default.toCanvas(qr, qr.dataset.qrUrl, {
    margin: 2,
    width: qr.dataset.width ? parseInt(qr.dataset.width) : 320
  });
}
//# sourceMappingURL=bits.qrcode.AMTVPNDB.js.map
