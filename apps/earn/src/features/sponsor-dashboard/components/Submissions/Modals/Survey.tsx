...
import { Dialog, DialogContent, DialogHeader } from '@earn/components/ui/dialog';

import { Rating } from '@earn/features/surveys/components/Rating';
import { getMatchingSurvey } from '@earn/features/surveys/utils/get-matching-survey';
