...
import SuperteamIcon from '@earn/components/icons/SuperteamIcon';
import { useExternalLinkDialog } from '@earn/components/shared/ExternalLinkDialogProvider';
import { SuperteamBadge } from '@earn/components/shared/SuperteamBadge';
import { Button } from '@earn/components/ui/button';
import { CircularProgress } from '@earn/components/ui/progress';
import { type BountyType } from '@earn/generated/prisma/enums';
...
import { isUserEligibleForST } from '@earn/features/grants/utils/stGrant';
import { userStatsQuery } from '@earn/features/home/queries/user-stats';
...
import styles from '@earn/styles/listing-description.module.css';
          ...
          {isST ? (
            ...
            <div className="w-100 rounded-xl bg-white px-8 pt-6 pb-10">
              ...
              <div className="mt-4 flex gap-3">
                <SuperteamIcon className="text-brand-grey ml-0.5 size-9" />
                <div className="flex flex-col">
                  <p className="text-md text-slate-500">
