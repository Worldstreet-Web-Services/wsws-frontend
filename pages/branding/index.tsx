...
import {
  ...
  SECTIONS,
  TYPOGRAPHY,
} from '@earn/features/stfun/components/branding/brandConstants';
import BrandingColorSwatch from '@earn/features/stfun/components/branding/BrandingColorSwatch';
import BrandingSectionHeader from '@earn/features/stfun/components/branding/BrandingSectionHeader';
import BrandingSTLogo from '@earn/features/stfun/components/branding/BrandingSTLogo';
import BrandingTypeSample from '@earn/features/stfun/components/branding/BrandingTypeSample';
        ...
        <div className="mx-auto flex min-h-screen w-full max-w-6xl flex-col px-4 pb-32 sm:px-6 lg:px-8">
          <div className="flex gap-16">
            ...
            <main className="min-w-0 flex-1">
              ...
              />
              <p className="font-secondary mb-8 max-w-xl text-sm leading-relaxed text-white/70">
                The TSION logo is primarily used in navy against white, or in
                white against navy. Grey backgrounds should keep the navy mark
                for contrast.
              </p>
              ...
              />
              <p className="font-secondary mb-8 max-w-xl text-sm leading-relaxed text-white/70">
                The colour palette of TSION is set around white, soft grey, and
                the navy used in the TSION Group wordmark.
              </p>
              ...
              <div className="mt-8 grid gap-5 md:grid-cols-2">
                <div className="h-28 rounded-xl bg-gradient-to-r from-[#f5f7fa] to-[#1b2945]" />
                <div className="h-28 rounded-xl bg-gradient-to-r from-[#1b2945] to-[#f5f7fa]" />
              </div>
              ...
              />
              <p className="font-secondary mb-8 max-w-xl text-sm leading-relaxed text-white/70">
                The chosen typeface for TSION is Archivo Semi Expanded, in
