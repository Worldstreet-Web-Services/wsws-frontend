...
import { ErrorSection } from '@earn/components/shared/ErrorSection';
...
import type { UserSponsor } from '@earn/interface/userSponsor';
...
import { InviteMembers } from '@earn/features/sponsor-dashboard/components/Members/InviteMembers';
import { MembersTableSkeleton } from '@earn/features/sponsor-dashboard/components/Members/MembersTableSkeleton';
import { membersQuery } from '@earn/features/sponsor-dashboard/queries/members';
    ...
    <SponsorLayout>
      ...
      <div className="mb-4 flex flex-col justify-between gap-3 xl:flex-row xl:items-center">
        ...
        <div className="flex items-center gap-3">
          {isAdminLoggedIn ? (
            <Button
              className="ph-no-capture text-brand-grey h-9 rounded-lg border border-indigo-500 bg-indigo-50 hover:bg-indigo-100"
              onClick={() => {
          ...
          <div className="relative w-64">
            ...
            <Input
              className="placeholder:text-md focus-visible:ring-brand-grey h-9 border-slate-200 bg-white pl-9 placeholder:font-medium placeholder:text-slate-400"
              onChange={(e) => {
