...
const ProjectTemplates = [
  ...
  },
  {
    ...
    icon: ShieldHalf,
    prompt:
      'Looking for a Rust developer to audit and optimize our smart contracts on TSION. Need someone who can identify potential vulnerabilities and improve transaction efficiency. Experience with Anchor framework required. \nEstimated 60 hours of work. Link to previous audits or TSION smart contract repos using Anchor. Security-first mindset is essential. \nFixed payment: 2000 USDC.',
  },
  {
