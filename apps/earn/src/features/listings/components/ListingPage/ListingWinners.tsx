...
import { nthLabelGenerator } from '@earn/utils/rank';
...
import { formatTotalPrize } from '@earn/features/listing-builder/utils/formatTotalPrize';
...
export function ListingWinners({ bounty }: Props) {
  ...
  return (
    <div className="bg-brand-grey/10 relative mx-auto w-full max-w-7xl rounded-lg px-4 pt-4">
