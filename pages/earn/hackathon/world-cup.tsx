    ...
    <Default
      ...
      meta={
        <>
          ...
          <Meta
            title="World Cup Hackathon | TSION Earn"
...
function PrizeSummary({ stats }: { stats: Stats | undefined }) {
  return (
    <section className="flex flex-col gap-1 overflow-hidden text-[#4B4C91]">
      <div className="flex items-center justify-between rounded-md bg-[#6c737b1C] px-5 py-4">
      ...
      <div className="rounded-md bg-[#6c737b1C] px-5 py-4 text-[14px] leading-relaxed font-medium text-[#4b5563]">
        ...
        and fan experiences. All powered by TxODDS’ live football API on TSION.
      </div>
    </section>
  );
}
...
function WorldCupTrackCard({
  ...
  return (
    <Link
      ...
      className="grid grid-cols-[8.75rem_1fr] overflow-hidden rounded-md bg-[#F8F8F8] text-left shadow-[inset_0_0_0_1px_#F0F0F0] transition focus-visible:ring-2 focus-visible:ring-indigo-500 focus-visible:ring-offset-2 active:bg-[#6c737b22] sm:grid-cols-[13.5rem_1fr] [@media(hover:hover)]:hover:bg-[#6c737b22]"
    >
      <div
