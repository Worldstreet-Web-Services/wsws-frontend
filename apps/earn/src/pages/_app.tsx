...
import Providers from '@earn/components/providers';
import { ST_ROUTES } from '@earn/constants/ST_ROUTES';
import { TokenListProvider } from '@earn/constants/tokenList';
import { fontVariables } from '@earn/theme/fonts';
import { stFontVariables } from '@earn/theme/fonts-st';

import Footer from '@earn/features/stfun/components/common/Footer';
import Header from '@earn/features/stfun/components/common/Header';
...
const TopLoader = dynamic(
  () => import('@earn/components/ui/toploader').then((mod) => mod.TopLoader),
  { ssr: false },
);
...
function App({ Component, pageProps }: AppProps) {
  ...
  useEffect(() => {
    ...
    import('@earn/lib/gsap').then(({ gsap, ScrollTrigger }) => {
