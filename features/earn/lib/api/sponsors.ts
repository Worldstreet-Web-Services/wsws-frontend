...
import { earnAuthedGet, earnGet, earnPost } from "@/features/earn/lib/api/client";
import { toSponsor, type SponsorWire } from "@/features/earn/lib/api/wire";
import { FIXTURE_SPONSOR, USE_FIXTURES } from "@/features/earn/lib/api/fixtures";
import type {
  CreateSponsorInput,
  Sponsor,
  SponsorProfileInput,
