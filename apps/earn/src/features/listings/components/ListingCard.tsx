...
import IoIosStar from '@earn/components/icons/IoIosStar';
import MdModeComment from '@earn/components/icons/MdModeComment';
...
import { timeAgoShort } from '@earn/utils/timeAgo';
  ...
  return (
    <Link
      ...
      className={cn(
        ...
        isFeatured && isBeforeDeadline ? 'bg-slate-50' : '',
      )}
    >
      <div className="flex w-full items-center justify-between">
