...
import { useCustomNoteCloseGuard } from '@earn/features/sponsor-dashboard/components/GrantApplications/hooks/useCustomNoteCloseGuard';
import { CustomNoteEditor } from '@earn/features/sponsor-dashboard/components/GrantApplications/Modals/CustomNoteEditor';
import {
  getCustomEmailPlainText,
  sanitizeCustomEmailBody,
  validateCustomEmailNote,
} from '@earn/features/sponsor-dashboard/utils/customEmailSanitizer';
import { getTrancheApprovedEmailBody } from '@earn/features/sponsor-dashboard/utils/grantEmailCopy';
