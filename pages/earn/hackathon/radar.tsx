...
import { RadarLogo } from '@earn/svg/radar-logo';
...
export default function Radar() {
  ...
  return (
    <Default
      ...
      meta={
        <Meta
          title="Radar | TSION Earn"
          description="Build a project for the latest TSION global hackathon!"
      ...
      <div className="animate-fadeIn">
        ...
        >
          ...
          <p className="mt-1 max-w-[28rem] px-6 text-center text-lg text-[#AAA199]">
            Submit to exclusive tracks of the latest TSION Global Hackathon on
            Earn
          </p>
          ...
          <div className="flex items-center gap-6">
            <Button
              ...
              onClick={() =>
                window.open(
                  'https://build.superteam.fun/ideas?utm_source=tsionearn&utm_campaign=radar',
                  '_blank',
                )
              }
            >
