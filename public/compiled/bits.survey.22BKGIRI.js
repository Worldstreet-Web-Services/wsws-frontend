// ../bits/src/bits.survey.ts
var informalLangs = /* @__PURE__ */ new Set(["cs", "de", "es", "it", "nl"]);
var surveyLangs = /* @__PURE__ */ new Set([
  "en",
  "ar",
  "zh-Hans",
  "cs-informal",
...
var SURVEY_BASE = "https://survey.lichess.org/index.php/";
function toLimeSurveyLang(code) {
...
function surveyUrl(id, token, lang) {
...
//# sourceMappingURL=bits.survey.22BKGIRI.js.map
