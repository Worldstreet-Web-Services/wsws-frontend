...
import { CUSTOM_FLAGS } from '@earn/constants/CUSTOM_FLAGS';
import { findChapterByRegionInput } from '@earn/utils/chapterRegion';
import { loadGoogleFont } from '@earn/utils/ogHelpers';
          ...
          >
            ...
            >
              ...
              >
                ...
                <span style={{ color: '#6c737b', display: 'flex' }}>
                  {region}
                </span>
