...
import { TalentForm } from '@earn/features/talent/components/onboarding-form/Form';
import { TalentImageCard } from '@earn/features/talent/components/onboarding-form/ImageCard';
...
export default function Talent() {
  ...
  return (
    <Default
      meta={
        <Meta
          title="Create Your Profile to Access Bounties & Grants | TSION Earn"
