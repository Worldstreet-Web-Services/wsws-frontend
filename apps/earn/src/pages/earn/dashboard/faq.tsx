import {
  ...
  AccordionItem,
  AccordionTrigger,
} from '@earn/components/ui/accordion';
import { SponsorLayout } from '@earn/layouts/Sponsor';

import { HelpBanner } from '@earn/features/sponsor-dashboard/components/HelpBanner';
...
<a style="color: blue" href="https://docs.google.com/spreadsheets/d/18Pahc-_9WhXezz7DW2kjwE1Iu-ExbOFtoxlPPsavsvg/edit?gid=0#gid=0" target="_blank">Click here</a> to access the Listings Menu, which contains ideas, listing examples, suggested prize ranges, etc.`,
      },
      {
        ...
        answer: `No! TSION Earn is completely free to use. There are no listing or platform fees.`,
      },
      {
      ...
      },
      {
        ...
        answer: `When you publish a listing on TSION Earn, it can be distributed across multiple high-visibility channels, including:
<br />
<br />
...
<br />
<strong>2. Community Channels:</strong> Listings are shared in relevant TSION community channels.
<br />
<strong>3. X:</strong> Listings with <strong>rewards over $1,000</strong> are amplified to reach a global audience via TSION Earn's <a style="color: blue" href="https://x.com/TSIONGroup" target="_blank">X</a> profile.
<br />
...
<br />
• Listings with <strong>rewards above $1,000</strong> are amplified via our <a style="color: blue" href="https://x.com/TSIONGroup" target="_blank">X</a> and are more likely to be included in <strong>email blasts</strong> and other community channels.
<br />
<br />
  ...
  <ul class="list-disc space-y-2 pl-5 mt-2">
    ...
    <li>You can add up to <strong>300 bonus spots</strong>.</li>
      ...
      },
      {
        ...
        answer: `Yes! Use custom labels such as <span class="inline-flex items-center rounded-full border border-amber-200 bg-orange-50 px-2.5 py-0.5 text-xs font-medium text-amber-600 capitalize select-none whitespace-nowrap">Unreviewed</span>, <span class="inline-flex items-center rounded-full border border-blue-300 bg-blue-100 px-2.5 py-0.5 text-xs font-medium text-blue-600 capitalize select-none whitespace-nowrap">Reviewed</span>, <span class="inline-flex items-center rounded-full border border-emerald-300 bg-emerald-100 px-2.5 py-0.5 text-xs font-medium text-emerald-600 capitalize select-none whitespace-nowrap">Winner</span>, <span class="inline-flex items-center rounded-full border border-slate-300 bg-slate-100 px-2.5 py-0.5 text-xs font-medium text-slate-600 capitalize select-none whitespace-nowrap">Shortlisted</span>, and <span class="inline-flex items-center rounded-full border border-red-300 bg-red-100 px-2.5 py-0.5 text-xs font-medium text-red-600 capitalize select-none whitespace-nowrap">Spam</span> to manage and organize submissions before announcing winners.`,
      },
      {
