...
import { Drawer, DrawerContent } from '@earn/components/ui/drawer';
...
import { Nudge } from '@earn/features/credits/components/Nudge';
import { ReferralModal } from '@earn/features/credits/components/ReferralModal';
import { CreditIcon } from '@earn/features/credits/icon/credit';
import { SurveyModal } from '@earn/features/listings/components/Submission/Survey';
  ...
  switch (buttonState) {
    ...
    default:
      if (
        ...
        buttonBG = isUserPro && isPro ? 'bg-zinc-800' : 'bg-brand-grey';
                  ...
                  className={cn(
                    ...
                    isEditMode &&
                      (isPro
                        ...
                        : 'border-brand-grey text-brand-grey hover:text-brand-grey-dark'),
            ...
            {creditBalance <= 0 && (
              <div className="w-full space-y-3">
                ...
                <Button
                  variant="ghost"
                  size="sm"
                  className="text-brand-grey hover:text-brand-grey h-10 w-full justify-between rounded-lg border border-gray-200 bg-white text-sm font-medium shadow hover:bg-indigo-50"
