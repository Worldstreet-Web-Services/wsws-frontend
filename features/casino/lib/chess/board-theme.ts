...
// Switchable board palettes. Wood matches Lichess's default round presentation,
// while the other palettes remain available in the board menu.
...
export const DEFAULT_THEME = BOARD_THEMES.find((theme) => theme.id === "brown") ?? BOARD_THEMES[0];
