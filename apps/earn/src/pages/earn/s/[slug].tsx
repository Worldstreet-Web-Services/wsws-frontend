...
import { LinkTextParser } from '@earn/components/shared/LinkTextParser';
...
import { getSponsorStats, type SponsorStats } from '@earn/pages/api/sponsors/stats';
...
import {
  ...
  ListingsSection,
} from '@earn/features/listings/components/ListingsSection';
  ...
  return (
    <Default
      ...
      meta={
        <>
          <Meta
            title={`${name} Opportunities | TSION Earn`}
