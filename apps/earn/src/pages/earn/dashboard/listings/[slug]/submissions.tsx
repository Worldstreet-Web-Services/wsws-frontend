...
import { Dialog, DialogContent } from '@earn/components/ui/dialog';
...
import { type SubmissionLabels } from '@earn/prisma/enums';
import { useUser } from '@earn/store/user';
import { cn } from '@earn/utils/cn';
import { dayjs } from '@earn/utils/dayjs';
import { cleanRewards } from '@earn/utils/rank';

import { BONUS_REWARD_POSITION } from '@earn/features/listing-builder/constants';
import {
  selectedSubmissionAtom,
  selectedSubmissionIdsAtom,
} from '@earn/features/sponsor-dashboard/atoms';
import { PublishResults } from '@earn/features/sponsor-dashboard/components/PublishResults';
import { ScoutTable } from '@earn/features/sponsor-dashboard/components/Scouts/ScoutTable';
import { MultiActionModal } from '@earn/features/sponsor-dashboard/components/Submissions/Modals/MultiActionModal';
import { Survey } from '@earn/features/sponsor-dashboard/components/Submissions/Modals/Survey';
import { PayoutSection } from '@earn/features/sponsor-dashboard/components/Submissions/PayoutSection';
import { SubmissionHeader } from '@earn/features/sponsor-dashboard/components/Submissions/SubmissionHeader';
import { SubmissionList } from '@earn/features/sponsor-dashboard/components/Submissions/SubmissionList';
import { SubmissionPanel } from '@earn/features/sponsor-dashboard/components/Submissions/SubmissionPanel';
import { SubmissionsPageSkeleton } from '@earn/features/sponsor-dashboard/components/Submissions/SubmissionsPageSkeleton';
import { useAutoSwitchSponsor } from '@earn/features/sponsor-dashboard/hooks/use-auto-switch-sponsor';
import { sponsorDashboardListingQuery } from '@earn/features/sponsor-dashboard/queries/listing';
import { scoutsQuery } from '@earn/features/sponsor-dashboard/queries/scouts';
import { submissionsQuery } from '@earn/features/sponsor-dashboard/queries/submissions';
import { type ScoutRowType } from '@earn/features/sponsor-dashboard/types';
            ...
            >
              <div className="mx-auto w-fit rounded-lg">
                ...
                <div className="flex items-center gap-3">
                  ...
                  <Button
                    className="rounded-lg border border-slate-300 bg-slate-50 text-slate-600 hover:bg-slate-100 disabled:opacity-50"
                    disabled={selectedSubmissionIds.size === 0}
