...
import { LocalPredictionCard } from "@/features/prediction/components/prediction-card-local";
import { EventCard } from "@/features/prediction/components/event-card-local";
import { LocalPredictionSlider } from "@/features/prediction/components/prediction-slider-local";
import { PortfolioPanel } from "@/features/prediction/components/positions-panel-local";
import { CreateMarketFlow } from "@/features/prediction/components/create-market-flow";
import { useMarkets, useCategories } from "@/features/prediction/hooks/use-prediction-markets";
import { useGroups } from "@/features/prediction/hooks/use-prediction-detail";
import type { Market, MarketGroup, MarketStatus } from "@/features/prediction/lib/types";
