...
import { agentRegisterRateLimiter } from '@earn/lib/ratelimit';
import { checkAndApplyRateLimitPages } from '@earn/lib/rateLimiterService';
import { prisma } from '@earn/prisma';
import { PrismaClientKnownRequestError } from '@earn/prisma/internal/prismaNamespace';
import { safeStringify } from '@earn/utils/safeStringify';

import {
  generateApiKey,
  generateClaimCode,
} from '@earn/features/agents/utils/agentTokens';
import { generateUniqueRandomUsername } from '@earn/features/talent/utils/generateUniqueRandomUsername';
