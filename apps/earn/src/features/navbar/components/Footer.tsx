...
import { SkillsCombobox } from '@earn/components/shared/SkillsCombobox';
...
import { skillSubSkillMap } from '@earn/interface/skills';
        ...
        <div className="flex flex-col items-start justify-between md:flex-row">
          <div className="mb-8 flex max-w-[540px] flex-col md:mb-0">
            ...
            <p className="mb-6 text-sm text-slate-500">
              ...
              best TSION companies in one place and apply to them using a
              single profile.
            </p>
        ...
        <div className="mx-auto max-w-7xl px-4">
          <div className="flex flex-col items-start justify-between md:flex-row md:items-center">
            <p className="mb-4 text-sm text-slate-500 md:mb-0">
              © {currentYear} TSION Group. All rights reserved.
            </p>
