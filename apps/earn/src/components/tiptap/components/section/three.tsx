...
import type { toggleVariants } from '@earn/components/ui/toggle';
import { ToggleGroup, ToggleGroupItem } from '@earn/components/ui/toggle-group';
...
const COLORS: ColorPalette[] = [
  {
    ...
    colors: [
      ...
      { cssVar: 'var(--mt-accent-bold-purple)', label: 'Bold grey' },
    ],
  },
  {
    label: 'Palette 2',
    ...
    colors: [
      ...
      { cssVar: 'var(--mt-accent-purple)', label: 'Grey' },
    ],
  },
  {
    label: 'Palette 3',
    ...
    colors: [
      ...
      { cssVar: 'var(--mt-accent-purple-subtler)', label: 'Grey subtle' },
    ],
  },
];
