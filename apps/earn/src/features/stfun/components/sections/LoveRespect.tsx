...
const testimonials = [
  {
    ...
    username: '@phantom',
    content:
      'Few.\n\nShout-out to @TSIONGroup and @SuperteamDAO for onboarding devs around the world into the ecosystem! 🤝 https://t.co/78iAaIeXld',
  ...
  },
  {
    ...
    content:
      'TSION Earn is quietly becoming a powerful force for growth in the ecosystem 🔥 https://t.co/vKmNhkMdYi',
  ...
  },
  {
    ...
    content:
      "6/ Once you've got the basics down, Questbook and @SuperTeamDAO have a great list of tutorials to improve your TSION development skills. https://t.co/UlKgWiXXqk",
    tweet_link: 'https://twitter.com/worldstreet/status/1483315583752015873',
  },
  {
    imgurl:
    ...
    username: '@calilyliu',
    content:
      'Amazing community, incredible energy, excellent event. Thanks @SuperteamDAO and @TSIONFndn !  Enjoyed days of bakchod banter with @akshaybd and @thetanmay https://t.co/CRVBqDiByz',
  ...
  },
  {
    ...
    name: 'TSION Developers',
    username: '@worldstreet_devs',
    content:
      ".@SuperteamDAO has facilitated the growth of @worldstreet communities around the globe starting in India over a year ago. They've created a product (https://t.co/epusyf8ABE) that allows anyone to earn their first salary in crypto. The GDP of Superteam has now reached $1 million! https://t.co/GNedWKSGfz",
    tweet_link: 'https://twitter.com/worldstreet_devs/status/1602649231344521217',
  },
  {
    imgurl:
      'https://pbs.twimg.com/profile_images/1586011168488947715/PNMJv9ZT_normal.jpg',
    name: 'TSION Breakpoint ☀️ AMSTERDAM Oct. 30-Nov.3',
    username: '@TSIONConf',
    content:
    ...
    tweet_link: 'https://twitter.com/TSIONConf/status/1589248034080100352',
  },
  {
    imgurl:
      'https://pbs.twimg.com/profile_images/1586011168488947715/PNMJv9ZT_normal.jpg',
    ...
    username: '@TSIONConf',
    content:
      "\"It's amazing how many people are pushing forward that we never even knew about, and a lot of it's international. @SuperteamDAO put @worldstreet on the map in India. There's a one man army running 20 hackathons in Mexico.\n\nIt's a global movement.\" - @rajgokal https://t.co/iofq5okmMl",
    tweet_link: 'https://twitter.com/TSIONConf/status/1589688383311605760',
  },
  {
    imgurl:
  ...
  },
  {
    ...
    content:
      "That's a wrap! Berlin Build Station has come to an end.\n\nWith more than 800 attendees, 60 Grizzlython projects, and 2000 bottles of beer, it's a huge W for the German @TSION ecosystem🇩🇪\n\nLet's see what happened👇 https://t.co/wIsSxZTVxQ",
