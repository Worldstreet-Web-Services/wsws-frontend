...
import HeroContainer from '@earn/features/stfun/components/common/HeroContainer';
import CollabServices from '@earn/features/stfun/components/sections/CollabServices';
...
export default function Collaborate() {
  return (
    <>
      <Meta
        title="Work with Superteam | Access the Best Talent on TSION"
        description="Get access to skilled contributors through TSION Earn."
      ...
      <div className="col-span-5 h-fit">
        <section className="hero relative col-span-5 flex h-[calc(100vh-40px-32px)] flex-col items-center">
          <HeroContainer
            line1="get access to"
            line2="the best talent on TSION"
            line3="superteam is the forefront community for web3,"
            line4="powered by worldstreet."
            buttonVisible={false}
          />
