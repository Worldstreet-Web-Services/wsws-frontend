    ...
    <div className="productions-container col-span-5 mt-44 flex flex-col justify-center text-center">
      ...
      <div className="mx-auto mt-0 flex max-w-[976px] flex-col gap-[12px] px-4 lg:mt-[53px]">
        <Accordion
          ...
          content="Sponsor or participate in small tasks and projects in the TSION ecosystem."
          btnText="Learn more"
        ...
        <Accordion
          ...
          content="Fund or apply for small grants to get started any projects — code, content or community for the TSION ecosystem. You might just make the next moonshot!"
          btnText="Learn more"
