import { zodResolver } from '@earn/lib/zodResolver';
...
import { ImageUploader } from '@earn/components/shared/ImageUploader';
import { Button } from '@earn/components/ui/button';
import { Checkbox } from '@earn/components/ui/checkbox';
import {
  Form,
  FormControl,
  FormField,
...
import { FormFieldWrapper } from '@earn/components/ui/form-field-wrapper';
import { Input } from '@earn/components/ui/input';
import { MultiSelect } from '@earn/components/ui/multi-select';
import { Separator } from '@earn/components/ui/separator';
import { Tooltip } from '@earn/components/ui/tooltip';
import { JTTG } from '@earn/constants/Telegram';
...
import { SignIn } from '@earn/features/auth/components/SignIn';
import { SocialInput } from '@earn/features/social/components/SocialInput';
import { extractSocialUsername } from '@earn/features/social/utils/extractUsername';
import { useSlugValidation } from '@earn/features/sponsor/hooks/useSlugValidation';
import { useSponsorNameValidation } from '@earn/features/sponsor/hooks/useSponsorNameValidation';
import {
  shouldUpdateUser,
  sponsorFormSchema,
  type SponsorFormValues,
  transformFormToApiData,
} from '@earn/features/sponsor/utils/sponsorFormSchema';
import { IndustryList, ONBOARDING_KEY } from '@earn/features/talent/constants';
import { useUsernameValidation } from '@earn/features/talent/utils/useUsernameValidation';
...
const CreateSponsor = () => {
  ...
  return (
    <Default
      meta={
        <Meta
          title="Create Sponsor | TSION Earn"
          description="Every TSION opportunity in one place!"
            ...
            <Form {...form}>
              ...
              >
                ...
                <div className="flex w-full justify-between gap-4">
                  ...
                  >
                    <Input placeholder="TSION" value={sponsorName} />
                  </FormFieldWrapper>
                  <FormFieldWrapper
                    control={form.control}
                    name="sponsor.slug"
                  ...
                  >
                    <Input placeholder="worldstreet" value={slug} />
                  </FormFieldWrapper>
                </div>
                <div className="my-6 flex w-full justify-between gap-4">
                  <FormFieldWrapper
                    ...
                    isRequired
                  >
                    <Input placeholder="https://worldstreet.com" />
                  </FormFieldWrapper>
                ...
                <div className="my-6 flex flex-col gap-2">
                  <div className="flex items-start space-x-2">
                    <Checkbox
                      id="acknowledgement"
                      className="data-[state=checked]:border-brand-grey data-[state=checked]:bg-brand-grey mt-1"
                    ...
                    >
                      ...
                      on, or supports, the TSION blockchain, and that Superteam
                      Earn is a platform exclusively for teams and projects
                      within the TSION ecosystem.
