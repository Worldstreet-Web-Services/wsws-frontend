...
import { Dialog, DialogClose, DialogContent } from '@earn/components/ui/dialog';
...
import { BountyIcon } from '@earn/svg/bounty-icon';
import { ProjectIcon } from '@earn/svg/project-icon';

import { getVisibleHackathons } from '@earn/features/hackathon/utils/getVisibleHackathons';
